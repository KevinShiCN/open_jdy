---
title: "查询网络锁 更新于2025-03-06 21:22 复制链接"
product: "金蝶云星辰"
category: "系统设置 > 查询网络锁"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=17294ce4fa8d11ef9452613c00d0cc6d"
last_update: "2025-03-06 21:22"
crawl_date: "2026-03-03"
---

# 查询网络锁 更新于2025-03-06 21:22 复制链接

> 产品：金蝶云星辰 | 分类：系统设置 > 查询网络锁

查询网络锁 更新于2025-03-06 21:22 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：查询网络锁
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/sys/mutex_list
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| 参数名称      | 参数类型   | 是否必填  | 参数说明                               |
| --- | --- | --- | --- |
| bill_type | string | false | 单据或基础资料类型id，参照《系统设置》-《基础资料及业务单据类型》 
| ids       | array  | false | 单据或基础资料id集合                        
| page      | string | false | 当前页，默认1                    
| page_size | string | false | 每页显示条数默认10，最大为100                         

#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/sys/mutex_list?bill_type=inv_product_bill&ids=[]&page=1&page_size=100' \
...
| 参数名称          | 参数类型    | 参数说明                                             |
| --- | --- | --- |
| client        | string  | 生产锁客户端：api,APP,web                               
| entity_key_id | string  | 单据或基础资料类型id                                      
| id            | string  | 网络锁id                                            
| itself        | boolean | 标识是否为当前会话。只有网络锁是当前用户在当前客户端创建时，查询返回为true,否则为false 
| object_id     | string  | 单据id                                             
| operation_key | string  | 操作key,下推:botp_convert,修改:modify                  
| user_id       | string  | 用户ID                                             
...
```json
{
	"data":{
		...
		"rows":[
			{
				"client":"api",
				"entity_key_id":"inv_product_bill",
				"id":"1",
				"itself":1,
				"object_id":"1",
				"operation_key":"push",
...
<li>用途说明：查询网络锁</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/sys/mutex_list</li>
</ul>
...
<td>string</td>
<td>false</td>
<td>单据或基础资料类型id，参照《系统设置》-《基础资料及业务单据类型》</td>
</tr>
<tr>
<td>ids</td>
<td>array</td>
...
<td>string</td>
<td>false</td>
<td>每页显示条数默认10，最大为100</td>
</tr>
</tbody>
</table>
<h4><a id="_26"></a>请求示例</h4>
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/sys/mutex_list?bill_type=inv_product_bill&amp;ids=[]&amp;page=1&amp;page_size=100&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
...
<td>itself</td>
<td>boolean</td>
<td>标识是否为当前会话。只有网络锁是当前用户在当前客户端创建时，查询返回为true,否则为false</td>
</tr>
<tr>
<td>object_id</td>
<td>string</td>
...
<td>operation_key</td>
<td>string</td>
<td>操作key,下推:botp_convert,修改:modify</td>
</tr>
<tr>
<td>user_id</td>
<td>string</td>
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		...
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				<span class="hljs-attr">&quot;client&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;api&quot;</span><span class="hljs-punctuation">,</span>
				<span class="hljs-attr">&quot;entity_key_id&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;inv_product_bill&quot;</span><span class="hljs-punctuation">,</span>
				...
				<span class="hljs-attr">&quot;itself&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-number">1</span><span class="hljs-punctuation">,</span>
				<span class="hljs-attr">&quot;object_id&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;1&quot;</span><span class="hljs-punctuation">,</span>
				<span class="hljs-attr">&quot;operation_key&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;push&quot;</span><span class="hljs-punctuation">,</span>
				<span class="hljs-attr">&quot;user_id&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;1&quot;</span><span class="hljs-punctuation">,</span>
				<span class="hljs-attr">&quot;user_name&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;1&quot;</span>
			<span class="hljs-punctuation">}</span>
