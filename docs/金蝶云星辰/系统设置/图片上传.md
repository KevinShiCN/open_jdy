---
title: "图片上传 更新于1970-01-01 08:00 复制链接"
product: "金蝶云星辰"
category: "系统设置 > 图片上传"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=7bbc0f25d70311eeaee3ed7b9eeba164"
last_update: "1970-01-01 08:00"
crawl_date: "2026-03-03"
---

# 图片上传 更新于1970-01-01 08:00 复制链接

> 产品：金蝶云星辰 | 分类：系统设置 > 图片上传

图片上传 更新于1970-01-01 08:00 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：图片单个上传
- 请求方式：POST
- 请求地址：https://api.kingdee.com/jdy/v2/basedata/image_upload
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| 参数名称        | 参数类型   | 是否必填  | 参数说明                 |
| --- | --- | --- | --- |
| base_string | string | true  | base64字符串,包含头部data信息 
| filename    | string | true  | 文件名称,带文件后缀           
| save_temp   | string | false | 是否上传到临时服务器,默认为true   
...
<li>用途说明：图片单个上传</li>
<li>请求方式：POST</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/basedata/image_upload</li>
</ul>
...
<td>string</td>
<td>false</td>
<td>是否上传到临时服务器,默认为true</td>
</tr>
</tbody>
</table>
<h4><a id="_25"></a>请求示例</h4>
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/basedata/image_upload&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				<span class="hljs-attr">&quot;url&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;false&quot;</span>
			<span class="hljs-punctuation">}</span>
		<span class="hljs-punctuation">]</span>
