---
title: "申请或释放网络锁 更新于2026-06-01 09:39 复制链接"
product: "金蝶云星辰"
category: "系统设置 > 申请或释放网络锁"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=1718d223fa8d11ef9452d3d4efd9788e"
last_update: "2026-06-01 09:39"
crawl_date: "2026-07-20"
---

# 申请或释放网络锁 更新于2026-06-01 09:39 复制链接

> 产品：金蝶云星辰 | 分类：系统设置 > 申请或释放网络锁

申请或释放网络锁 更新于2026-06-01 09:39 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：申请或释放网络锁
- 请求方式：POST
- 请求地址：https://api.kingdee.com/jdy/v2/sys/mutex_operate
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| 参数名称         | 参数类型    | 是否必填  | 参数说明                                 |
| --- | --- | --- | --- |
| bill_type    | string  | true  | 单据或基础资料类型id，参照《系统设置》-《基础资料及业务单据类型》   
| id           | string  | true  | 单据id                                 
| is_force     | boolean | true  | 是否强制释放锁，当需要强制释放其他会话网络时传递true默认：false 
| operate_type | string  | false | 操作类型，下推：botp_convert（默认），修改：modify   
| sign         | string  | false | 申请锁或释放锁，1：释放锁（默认）、0：申请锁              

#### 请求示例
```txt
curl --location --request  post 'https://api.kingdee.com/jdy/v2/sys/mutex_operate' \
...
--data-row '
{
	"bill_type":"inv_product_bill",
	"id":"12323",
	"is_force":false,
	"operate_type":"botp_convert",
	"sign":"1"
}'
```
### 响应参数
...
<li>用途说明：申请或释放网络锁</li>
<li>请求方式：POST</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/sys/mutex_operate</li>
</ul>
...
<td>boolean</td>
<td>true</td>
<td>是否强制释放锁，当需要强制释放其他会话网络时传递true默认：false</td>
</tr>
<tr>
<td>operate_type</td>
<td>string</td>
<td>false</td>
<td>操作类型，下推：botp_convert（默认），修改：modify</td>
</tr>
<tr>
<td>sign</td>
<td>string</td>
<td>false</td>
<td>申请锁或释放锁，1：释放锁（默认）、0：申请锁</td>
</tr>
</tbody>
</table>
<h4><a id="_27"></a>请求示例</h4>
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/sys/mutex_operate&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
