---
title: "附件上传 更新于2026-01-09 10:57 复制链接"
product: "金蝶云星辰"
category: "系统设置 > 附件上传"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=5519cba46cb811eebcbf655356d50503"
last_update: "2026-01-09 10:57"
crawl_date: "2026-03-03"
---

# 附件上传 更新于2026-01-09 10:57 复制链接

> 产品：金蝶云星辰 | 分类：系统设置 > 附件上传

附件上传 更新于2026-01-09 10:57 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：附件上传
- 请求方式：POST
- 请求地址：https://api.kingdee.com/jdy/v2/sys/attachment_upload
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
<li>用途说明：附件上传</li>
<li>请求方式：POST</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/sys/attachment_upload</li>
</ul>
...
<td>File</td>
<td>true</td>
<td>选中上传的文件（单个10m以内，最多每次上传1个文件）</td>
</tr>
</tbody>
</table>
<h4><a id="_23"></a>请求示例</h4>
<pre><div class="hljs"><code class="lang-txt">curl --location --request POST &#x27;https://api.kingdee.com/jdy/v2/sys/attachment_upload&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
--header &#x27;X-Api-Nonce: 1655775240000&#x27; \
...
<pre><div class="hljs"><code class="lang-json"><span class="hljs-punctuation">{</span>
    <span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
        <span class="hljs-attr">&quot;file1&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-string">&quot;https://tf.jdy.com/ierp/tempfile/download.do?configKey=xxxx&quot;</span>
    <span class="hljs-punctuation">}</span><span class="hljs-punctuation">,</span>
    <span class="hljs-attr">&quot;errorCode&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-string">&quot;success&quot;</span><span class="hljs-punctuation">,</span>
