---
title: "省市区查询 更新于2023-04-19 13:35 复制链接"
product: "金蝶云星辰"
category: "系统设置 > 省市区查询"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9e7e0199712511eda0b3993a7dc0d161"
last_update: "2023-04-19 13:35"
crawl_date: "2026-03-03"
---

# 省市区查询 更新于2023-04-19 13:35 复制链接

> 产品：金蝶云星辰 | 分类：系统设置 > 省市区查询

省市区查询 更新于2023-04-19 13:35 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：省市区查询
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/sys/division_load
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| name      | string             | 行政区域名称             
| parent_id | string             | 父级行政区域ID           
| son_nodes | List <CityLoadRes> | 下级行政区域列表           
...
| name      | string             | 行政区域名称             
| parent_id | string             | 父级行政区域ID           
| son_nodes | List <AreaLoadRes> | 下级行政区域列表           
...
<li>用途说明：省市区查询</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/sys/division_load</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/sys/division_load
</code></div></pre>
...
<tr>
<td>rows</td>
<td>List &lt;DivisionLoadRes&gt;</td>
<td>数据行</td>
</tr>
</tbody>
</table>
<p><strong>DivisionLoadRes</strong></p>
<table>
<thead>
<tr>
<th>参数名称</th>
...
<tr>
<td>son_nodes</td>
<td>List &lt;CityLoadRes&gt;</td>
<td>下级行政区域列表</td>
</tr>
</tbody>
</table>
<p><strong>CityLoadRes</strong></p>
<table>
<thead>
<tr>
<th>参数名称</th>
...
<tr>
<td>son_nodes</td>
<td>List &lt;AreaLoadRes&gt;</td>
<td>下级行政区域列表</td>
</tr>
</tbody>
</table>
<p><strong>AreaLoadRes</strong></p>
<table>
<thead>
<tr>
<th>参数名称</th>
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				...
				<span class="hljs-attr">&quot;son_nodes&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
					<span class="hljs-punctuation">{</span>
						<span class="hljs-attr">&quot;id&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;1&quot;</span><span class="hljs-punctuation">,</span>
						<span class="hljs-attr">&quot;level&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;1&quot;</span><span class="hljs-punctuation">,</span>
						<span class="hljs-attr">&quot;name&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;名称&quot;</span><span class="hljs-punctuation">,</span>
