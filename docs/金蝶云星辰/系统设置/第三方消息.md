---
title: "第三方消息 更新于2023-12-28 21:05 复制链接"
product: "金蝶云星辰"
category: "系统设置 > 第三方消息"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=b00cffe1a58111ee860dcf9d99cf5e50"
last_update: "2023-12-28 21:05"
crawl_date: "2026-03-03"
---

# 第三方消息 更新于2023-12-28 21:05 复制链接

> 产品：金蝶云星辰 | 分类：系统设置 > 第三方消息

第三方消息 更新于2023-12-28 21:05 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：消息中心添加第三方消息接口
- 请求方式：POST
- 请求地址：https://api.kingdee.com/jdy/v2/sys/outside_msg
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
<ul>
<li>用途说明：消息中心添加第三方消息接口</li>
<li>请求方式：POST</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/sys/outside_msg</li>
</ul>
...
<td>List &lt;string&gt;</td>
<td>true</td>
<td>推送渠道，格式：[“XXZX”,“APP”],目前支持4个渠道：XXZX：消息中心（建议默认带上）；APP：金蝶云APP，QYWX：企微，DD：钉钉</td>
</tr>
<tr>
<td>content</td>
<td>string</td>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/sys/outside_msg&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
...
<pre><div class="hljs"><code class="lang-json"><span class="hljs-punctuation">{</span>
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;执行成功&quot;</span><span class="hljs-punctuation">,</span>
		<span class="hljs-attr">&quot;message&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;失败原因&quot;</span><span class="hljs-punctuation">,</span>
