---
title: "通用操作(审核\反审核\删除) 更新于2025-12-25 21:29 复制链接"
product: "金蝶云星辰"
category: "系统设置 > 通用操作(审核\反审核\删除)"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9e804b8c712511eda0b39f724d124b07"
last_update: "2025-12-25 21:29"
crawl_date: "2026-03-03"
---

# 通用操作(审核\反审核\删除) 更新于2025-12-25 21:29 复制链接

> 产品：金蝶云星辰 | 分类：系统设置 > 通用操作(审核\反审核\删除)

通用操作(审核\反审核\删除) 更新于2025-12-25 21:29 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：通用批量操作
- 请求方式：POST
- 请求地址：https://api.kingdee.com/jdy/v2/sys/common_operate
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| 参数名称          | 参数类型          | 是否必填  | 参数说明                                                                    |
| --- | --- | --- | --- |
| entity_number | string        | false | 单据或基础资料类型，参照《系统设置》-《基础资料及业务单据类型》                                        
| ids           | List <string> | false | 单据id                                                                    
| ignore_warn   | boolean       | false | 是否忽略告警信息(如：名称已存在)保存客户，true:忽略，默认false                                   
| numbers       | List <string> | false | 编码                                                                      
| operate_type  | string        | false | 操作类型，删除delete、审核audit、反审核unaudit、订单关闭close_donothing、作废invalid、反作废valid 

#### 请求示例
```txt
curl --location --request  post 'https://api.kingdee.com/jdy/v2/sys/common_operate' \
...
<li>用途说明：通用批量操作</li>
<li>请求方式：POST</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/sys/common_operate</li>
</ul>
...
<td>string</td>
<td>false</td>
<td>单据或基础资料类型，参照《系统设置》-《基础资料及业务单据类型》</td>
</tr>
<tr>
<td>ids</td>
<td>List &lt;string&gt;</td>
...
<td>string</td>
<td>false</td>
<td>操作类型，删除delete、审核audit、反审核unaudit、订单关闭close_donothing、作废invalid、反作废valid</td>
</tr>
</tbody>
</table>
<h4><a id="_27"></a>请求示例</h4>
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/sys/common_operate&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
