---
title: "国家行政区域查询 更新于2024-06-27 21:12 复制链接"
product: "金蝶云星辰"
category: "系统设置 > 国家行政区域查询"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9e7ec4ea712511eda0b39917bf069706"
last_update: "2024-06-27 21:12"
crawl_date: "2026-03-03"
---

# 国家行政区域查询 更新于2024-06-27 21:12 复制链接

> 产品：金蝶云星辰 | 分类：系统设置 > 国家行政区域查询

国家行政区域查询 更新于2024-06-27 21:12 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：国家行政区域查询
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/sys/country_load
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/sys/country_load?enable=1&page=1&search=苹果&un_page=1' \
...
<li>用途说明：国家行政区域查询</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/sys/country_load</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/sys/country_load?enable=1&amp;page=1&amp;search=苹果&amp;un_page=1&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		...
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				...
				<span class="hljs-attr">&quot;full_name&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;名称&quot;</span><span class="hljs-punctuation">,</span>
