---
title: "用户信息列表 更新于2024-04-26 09:05 复制链接"
product: "金蝶云星辰"
category: "系统设置 > 用户信息列表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9e8db910712511eda0b3fdf2a45da973"
last_update: "2024-04-26 09:05"
crawl_date: "2026-03-03"
---

# 用户信息列表 更新于2024-04-26 09:05 复制链接

> 产品：金蝶云星辰 | 分类：系统设置 > 用户信息列表

用户信息列表 更新于2024-04-26 09:05 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：用户信息列表
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/sys/user_list
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
<li>用途说明：用户信息列表</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/sys/user_list</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/sys/user_list?enable=1&amp;page=1&amp;page_size=100&amp;phone=13333333333&amp;search=001&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
...
<td>phone</td>
<td>string</td>
<td><a href="https://open.jdy.com/#/files/api/detail?id=d7046d818dc111ee860d0fedad361070&amp;noside=true" target="_blank">敏感数据解密</a></td>
</tr>
</tbody>
</table>
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		...
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				...
				<span class="hljs-attr">&quot;phone&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;13322442211&quot;</span><span class="hljs-punctuation">,</span>
