---
title: "门店保存 更新于2024-01-25 21:42 复制链接"
product: "金蝶云星辰"
category: "零售云 > 门店管理 > 门店保存"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=5f962125bb8611eeaee3170e6ebe7cca"
last_update: "2024-01-25 21:42"
crawl_date: "2026-03-03"
---

# 门店保存 更新于2024-01-25 21:42 复制链接

> 产品：金蝶云星辰 | 分类：零售云 > 门店管理 > 门店保存

门店保存 更新于2024-01-25 21:42 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
...
| dept_id          | string        | true  | 门店所属部门ID                  
| group_id         | string        | true  | 门店分组ID                    
| lat              | string        | true  | 纬度                        
| lng              | string        | true  | 经度                        
| location_id      | string        | true  | 对应仓库id                    
| name             | string        | true  | 门店名                       
| sale_type        | string        | true  | 经营方式，1-自营，2-加盟，3-联营       
| telephone        | string        | true  | 手机号码                      
| contact          | string        | true  | 联系人                       
| customer_id      | string        | false | 关联客户ID，门店类型为加盟时必填         
| enable           | string        | false | 状态，默认1启用                  
| id               | string        | false | 门店id                      
| mulLabel_id_list | List <string> | false | 门店标签id列表                  
| number           | string        | false | 门店编号，为空系统自动生成编号，根据门店的编码规则 
| region_id        | string        | false | 行政区划id                    
...
--data-row '
{
	...
	"contact":"一号联系人d=true",
	"customer_id":"1",
	"dept_id":"697140092908614656",
	"enable":"1",
	"group_id":"697140092908614656",
	"id":"001",
	"lat":"001",
	"lng":"001",
...
<ul>
<li>用途说明：门店新增及修改。审核、删除等详见<a href="https://open.jdy.com/#/files/api/detail?index=2&amp;categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&amp;id=9e804b8c712511eda0b39f724d124b07" target="_blank">通用操作接口</a></li>
<li>请求方式：POST</li>
...
<td>string</td>
<td>false</td>
<td>门店编号，为空系统自动生成编号，根据门店的编码规则</td>
</tr>
<tr>
<td>region_id</td>
<td>string</td>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/ls/store&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
