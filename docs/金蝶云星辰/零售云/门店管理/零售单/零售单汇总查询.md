---
title: "零售单汇总查询 更新于2023-04-19 13:35 复制链接"
product: "金蝶云星辰"
category: "零售云 > 门店管理 > 零售单 > 零售单汇总查询"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=713d895fd86811edbfb2e30b6a0f8ec5"
last_update: "2023-04-19 13:35"
crawl_date: "2026-03-03"
---

# 零售单汇总查询 更新于2023-04-19 13:35 复制链接

> 产品：金蝶云星辰 | 分类：零售云 > 门店管理 > 零售单 > 零售单汇总查询

零售单汇总查询 更新于2023-04-19 13:35 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：零售单汇总查询
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/ls/retail_bill_statistic
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| 参数名称       | 参数类型   | 是否必填  | 参数说明                                                     |
| --- | --- | --- | --- |
| end_time   | string | true  | 结束时间                                                     
| start_time | string | true  | 开始时间                                                     
| biz_types  | array  | false | 默认查询63,64。业务类型 60.充值61.退充62.销售63.退货64.充次65.退充次66.还款67.到期 
| store_ids  | array  | false | 门店id                                                     
...
| 参数名称             | 参数类型             | 参数说明        |
| --- | --- | --- |
| amount_total     | number           | 价税合计，所有门店汇总 
| bal_amount_total | number           | 价税合计，所有门店汇总 
| count            | string           | 总条数         
| store_list       | List <StoreList> | 门店列表        

**StoreList**
| 参数名称       | 参数类型   | 参数说明 |
| --- | --- | --- |
| bal_amount | number | 充值金额 
...
<li>用途说明：零售单汇总查询</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/ls/retail_bill_statistic</li>
</ul>
...
<td>array</td>
<td>false</td>
<td>默认查询63,64。业务类型 60.充值61.退充62.销售63.退货64.充次65.退充次66.还款67.到期</td>
</tr>
<tr>
<td>store_ids</td>
<td>array</td>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/ls/retail_bill_statistic?end_time=2023-01-01 &amp;start_time=2022-01-01 &amp;biz_types= [] &amp;store_ids= [] &#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
...
<tr>
<td>store_list</td>
<td>List &lt;StoreList&gt;</td>
<td>门店列表</td>
</tr>
</tbody>
</table>
<p><strong>StoreList</strong></p>
<table>
<thead>
<tr>
<th>参数名称</th>
...
<pre><div class="hljs"><code class="lang-json"><span class="hljs-punctuation">{</span>
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		<span class="hljs-attr">&quot;amount_total&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-number">100</span><span class="hljs-punctuation">,</span>
		<span class="hljs-attr">&quot;bal_amount_total&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-number">100</span><span class="hljs-punctuation">,</span>
		...
		<span class="hljs-attr">&quot;store_list&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				...
				<span class="hljs-attr">&quot;bal_amount&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-number">1</span><span class="hljs-punctuation">,</span>
