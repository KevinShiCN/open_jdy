---
title: "反预核销 更新于2023-04-19 13:35 复制链接"
product: "金蝶云星辰"
category: "零售云 > 门店管理 > 反预核销"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9d9771b1712511eda0b39ff1b255b8f0"
last_update: "2023-04-19 13:35"
crawl_date: "2026-03-03"
---

# 反预核销 更新于2023-04-19 13:35 复制链接

> 产品：金蝶云星辰 | 分类：零售云 > 门店管理 > 反预核销

反预核销 更新于2023-04-19 13:35 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：反预核销
- 请求方式：POST
- 请求地址：https://api.kingdee.com/jdy/v2/ls/mall_pre_write_off_cancel
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
<li>用途说明：反预核销</li>
<li>请求方式：POST</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/ls/mall_pre_write_off_cancel</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/ls/mall_pre_write_off_cancel&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
