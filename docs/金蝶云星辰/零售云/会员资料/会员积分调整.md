---
title: "会员积分调整 更新于2023-05-25 14:01 复制链接"
product: "金蝶云星辰"
category: "零售云 > 会员资料 > 会员积分调整"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9d5d4fd3712511eda0b3637f5a600df7"
last_update: "2023-05-25 14:01"
crawl_date: "2026-03-03"
---

# 会员积分调整 更新于2023-05-25 14:01 复制链接

> 产品：金蝶云星辰 | 分类：零售云 > 会员资料 > 会员积分调整

会员积分调整 更新于2023-05-25 14:01 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：会员积分调整
- 请求方式：POST
- 请求地址：https://api.kingdee.com/jdy/v2/ls/integral_adjust
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
<li>用途说明：会员积分调整</li>
<li>请求方式：POST</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/ls/integral_adjust</li>
</ul>
...
<td>integer</td>
<td>true</td>
<td>调整类型(1：积分消费,2：积分抵现,3：积分兑换4：充值赠送,5：促销赠送,6：打卡赠送,7：到期清零,8：退款,9：购买积分,10：积分购买退款,11：会员签到赠送)</td>
</tr>
</tbody>
</table>
<h4><a id="_25"></a>请求示例</h4>
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/ls/integral_adjust&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
