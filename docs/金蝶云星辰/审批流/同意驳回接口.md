---
title: "同意驳回接口 更新于2026-05-26 20:18 复制链接"
product: "金蝶云星辰"
category: "审批流 > 同意驳回接口"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=00dc0c2a030711ef9080533aa6cdbc22"
last_update: "2026-05-26 20:18"
crawl_date: "2026-07-20"
---

# 同意驳回接口 更新于2026-05-26 20:18 复制链接

> 产品：金蝶云星辰 | 分类：审批流 > 同意驳回接口

同意驳回接口 更新于2026-05-26 20:18 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：同意驳回接口
- 请求方式：POST
- 请求地址：https://api.kingdee.com/jdy/v2/wf/approval_consent
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| 参数名称            | 参数类型                  | 是否必填  | 参数说明                      |
| --- | --- | --- | --- |
| bill_type       | string                | true  | 单据类型 (审核时规则校验必传)          
| business_key    | List <string>         | true  | 单据id                      
| op_type         | string                | true  | 操作类型：Consent 同意；Reject 驳回 
| opinion         | string                | true  | 同意或驳回意见                   
| attachments_url | List <AttachmentsUrl> | false | 附件                        
...
#### 请求示例
```txt
curl --location --request  post 'https://api.kingdee.com/jdy/v2/wf/approval_consent' \
...
| 参数名称      | 参数类型   | 参数说明                                                                |
| --- | --- | --- |
| op_result | string | 操作结果：executed,代表操作已执行，因为此为异步操作，具体的操作结果需要主动查询或重新刷新单据（在单据详情中自动加载最新状态） 
...
<li>用途说明：同意驳回接口</li>
<li>请求方式：POST</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/wf/approval_consent</li>
</ul>
...
<td>string</td>
<td>true</td>
<td>操作类型：Consent 同意；Reject 驳回</td>
</tr>
<tr>
<td>opinion</td>
<td>string</td>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/wf/approval_consent&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
...
<td>op_result</td>
<td>string</td>
<td>操作结果：executed,代表操作已执行，因为此为异步操作，具体的操作结果需要主动查询或重新刷新单据（在单据详情中自动加载最新状态）</td>
</tr>
</tbody>
</table>
...
<pre><div class="hljs"><code class="lang-json"><span class="hljs-punctuation">{</span>
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		<span class="hljs-attr">&quot;op_result&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;executed&quot;</span>
