---
title: "审批流撤回 更新于2026-05-26 20:18 复制链接"
product: "金蝶云星辰"
category: "审批流 > 审批流撤回"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=efc60a7a2f0511ef9b205b8eadc47cba"
last_update: "2026-05-26 20:18"
crawl_date: "2026-07-20"
---

# 审批流撤回 更新于2026-05-26 20:18 复制链接

> 产品：金蝶云星辰 | 分类：审批流 > 审批流撤回

审批流撤回 更新于2026-05-26 20:18 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：审批流申请人撤回接口
- 请求方式：POST
- 请求地址：https://api.kingdee.com/jdy/v2/wf/withdraw
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| 参数名称          | 参数类型   | 是否必填 | 参数说明                    |
| --- | --- | --- | --- |
| business_key  | string | true | 业务单据Id集合                
| entity_number | string | true | 单据或基础资料类型，参照《基础资料及单据类型》 

#### 请求示例
```txt
curl --location --request  post 'https://api.kingdee.com/jdy/v2/wf/withdraw' \
...
| 参数名称   | 参数类型   | 参数说明                                                                |
| --- | --- | --- |
| result | string | 操作结果：executed，代表操作已执行，因为此为异步操作，具体的操作结果需要主动查询或重新刷新单据（在单据详情中自动加载最新状态） 
...
<ul>
<li>用途说明：审批流申请人撤回接口</li>
<li>请求方式：POST</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/wf/withdraw</li>
</ul>
...
<td>string</td>
<td>true</td>
<td>单据或基础资料类型，参照《基础资料及单据类型》</td>
</tr>
</tbody>
</table>
<h4><a id="_24"></a>请求示例</h4>
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/wf/withdraw&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
...
<pre><div class="hljs"><code class="lang-json"><span class="hljs-punctuation">{</span>
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		<span class="hljs-attr">&quot;result&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;1&quot;</span>
