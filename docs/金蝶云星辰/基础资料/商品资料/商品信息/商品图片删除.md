---
title: "商品图片删除 更新于2023-10-19 21:07 复制链接"
product: "金蝶云星辰"
category: "基础资料 > 商品资料 > 商品信息 > 商品图片删除"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9c7ab79d712511eda0b3797d2b69bfe2"
last_update: "2023-10-19 21:07"
crawl_date: "2026-03-03"
---

# 商品图片删除 更新于2023-10-19 21:07 复制链接

> 产品：金蝶云星辰 | 分类：基础资料 > 商品资料 > 商品信息 > 商品图片删除

商品图片删除 更新于2023-10-19 21:07 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：删除商品图片
- 请求方式：DELETE
- 请求地址：https://api.kingdee.com/jdy/v2/bd/material_picture
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
<li>用途说明：删除商品图片</li>
<li>请求方式：DELETE</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/bd/material_picture</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  delete &#x27;https://api.kingdee.com/jdy/v2/bd/material_picture&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
...
<h4><a id="_52"></a>响应示例</h4>
<pre><div class="hljs"><code class="lang-json"><span class="hljs-punctuation">{</span>
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		<span class="hljs-attr">&quot;result&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;图片删除成功&quot;</span>
