---
title: "商品分类保存 更新于2024-05-09 21:20 复制链接"
product: "金蝶云星辰"
category: "基础资料 > 商品资料 > 商品分类 > 商品分类保存"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9c8a20f3712511eda0b32d9f5b29b998"
last_update: "2024-05-09 21:20"
crawl_date: "2026-03-03"
---

# 商品分类保存 更新于2024-05-09 21:20 复制链接

> 产品：金蝶云星辰 | 分类：基础资料 > 商品资料 > 商品分类 > 商品分类保存

商品分类保存 更新于2024-05-09 21:20 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：商品分类新增及修改。审核、删除等详见[通用操作接口](https://open.jdy.com/#/files/api/detail?index=2&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9e804b8c712511eda0b39f724d124b07)
- 请求方式：POST
...
| ignore_warn   | boolean | false | 是否忽略告警信息(如：名称：” 值 “12345” 已存在，请输入其他值。)分类保存 
| parent_id     | string  | false | 上级id                                       
| parent_number | string  | false | 上级编码                                       

#### 请求示例
```txt
curl --location --request  post 'https://api.kingdee.com/jdy/v2/bd/material_group' \
...
<ul>
<li>用途说明：商品分类新增及修改。审核、删除等详见<a href="https://open.jdy.com/#/files/api/detail?index=2&amp;categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&amp;id=9e804b8c712511eda0b39f724d124b07" target="_blank">通用操作接口</a></li>
<li>请求方式：POST</li>
...
<td>boolean</td>
<td>false</td>
<td>是否忽略告警信息(如：名称：” 值 “12345” 已存在，请输入其他值。)分类保存</td>
</tr>
<tr>
<td>parent_id</td>
<td>string</td>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/bd/material_group&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
