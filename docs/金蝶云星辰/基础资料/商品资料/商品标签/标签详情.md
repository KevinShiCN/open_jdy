---
title: "标签详情 更新于2023-04-19 13:35 复制链接"
product: "金蝶云星辰"
category: "基础资料 > 商品资料 > 商品标签 > 标签详情"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9c5d6b90712511eda0b351540e2c4734"
last_update: "2023-04-19 13:35"
crawl_date: "2026-03-03"
---

# 标签详情 更新于2023-04-19 13:35 复制链接

> 产品：金蝶云星辰 | 分类：基础资料 > 商品资料 > 商品标签 > 标签详情

标签详情 更新于2023-04-19 13:35 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：获取标签详情
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/bd/label_detail
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/bd/label_detail?id=1&number=001' \
...
| --- | --- | --- |
| id                   | string  | id       
| base_data_use_id     | string  | 标签适用资料id 
| base_data_use_name   | string  | 标签适用资料名称 
| base_data_use_number | string  | 标签适用资料编码 
| create_time          | string  | 创建时间     
| creator_id           | string  | 创建人id    
| creator_name         | string  | 创建人名称    
| is_prepared          | boolean | 是否系统预置   
| modifier_id          | string  | 修改人id    
| modifier_name        | string  | 修改人名称    
| modify_time          | string  | 修改时间     
| name                 | string  | 名称       
| number               | string  | 编码       
| parent_id            | string  | 标签分类id   
| parent_name          | string  | 标签分类名称   
| parent_number        | string  | 标签分类编码   
...
```json
{
	"data":{
		"base_data_use_id":"1",
		"base_data_use_name":"名称",
		"base_data_use_number":"001",
...
<li>用途说明：获取标签详情</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/bd/label_detail</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/bd/label_detail?id=1&amp;number=001&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
...
<tr>
<td>base_data_use_id</td>
<td>string</td>
<td>标签适用资料id</td>
</tr>
<tr>
<td>base_data_use_name</td>
<td>string</td>
<td>标签适用资料名称</td>
</tr>
<tr>
<td>base_data_use_number</td>
<td>string</td>
<td>标签适用资料编码</td>
</tr>
<tr>
...
<pre><div class="hljs"><code class="lang-json"><span class="hljs-punctuation">{</span>
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		<span class="hljs-attr">&quot;base_data_use_id&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;1&quot;</span><span class="hljs-punctuation">,</span>
		<span class="hljs-attr">&quot;base_data_use_name&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;名称&quot;</span><span class="hljs-punctuation">,</span>
		<span class="hljs-attr">&quot;base_data_use_number&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;001&quot;</span><span class="hljs-punctuation">,</span>
		<span class="hljs-attr">&quot;create_time&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;2020-02-10 13:43:52&quot;</span><span class="hljs-punctuation">,</span>
		...
		<span class="hljs-attr">&quot;is_prepared&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-keyword">true</span><span class="hljs-punctuation">,</span>
		...
		<span class="hljs-attr">&quot;modify_time&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;2020-02-10 13:43:52&quot;</span><span class="hljs-punctuation">,</span>
