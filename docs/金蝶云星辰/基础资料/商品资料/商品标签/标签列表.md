---
title: "标签列表 更新于2023-04-19 13:35 复制链接"
product: "金蝶云星辰"
category: "基础资料 > 商品资料 > 商品标签 > 标签列表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9c5ca83f712511eda0b35fc9a07dd0a3"
last_update: "2023-04-19 13:35"
crawl_date: "2026-03-03"
---

# 标签列表 更新于2023-04-19 13:35 复制链接

> 产品：金蝶云星辰 | 分类：基础资料 > 商品资料 > 商品标签 > 标签列表

标签列表 更新于2023-04-19 13:35 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：获取标签列表
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/bd/label
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| 参数名称              | 参数类型   | 是否必填  | 参数说明                         |
| --- | --- | --- | --- |
| base_data_use_id  | string | true  | 标签适用资料id                     
...
| parent_id         | string | false | 标签分类id                       
| search            | string | false | 模糊搜索-名称                      
| un_page           | string | false | 是否分页，1：不分页返回100条数据；默认分页，每页10 

#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/bd/label?base_data_use_id=1&create_end_time=1234567890123&create_start_time=1234567890123&enable=1&modify_end_time=1234567890123&modify_start_time=1234567890123&page=1&page_size=100&parent_id=1&search=名称&un_page=1' \
...
<li>用途说明：获取标签列表</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/bd/label</li>
</ul>
...
<td>string</td>
<td>false</td>
<td>是否分页，1：不分页返回100条数据；默认分页，每页10</td>
</tr>
</tbody>
</table>
<h4><a id="_33"></a>请求示例</h4>
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/bd/label?base_data_use_id=1&amp;create_end_time=1234567890123&amp;create_start_time=1234567890123&amp;enable=1&amp;modify_end_time=1234567890123&amp;modify_start_time=1234567890123&amp;page=1&amp;page_size=100&amp;parent_id=1&amp;search=名称&amp;un_page=1&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
