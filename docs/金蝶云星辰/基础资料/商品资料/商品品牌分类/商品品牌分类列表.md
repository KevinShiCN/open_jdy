---
title: "商品品牌分类列表 更新于2023-10-19 21:07 复制链接"
product: "金蝶云星辰"
category: "基础资料 > 商品资料 > 商品品牌分类 > 商品品牌分类列表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=a4e6e8e0faee11edb082b31c953fe6ce"
last_update: "2023-10-19 21:07"
crawl_date: "2026-03-03"
---

# 商品品牌分类列表 更新于2023-10-19 21:07 复制链接

> 产品：金蝶云星辰 | 分类：基础资料 > 商品资料 > 商品品牌分类 > 商品品牌分类列表

商品品牌分类列表 更新于2023-10-19 21:07 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
...
#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/bd/material_brand_group?page=1&page_size=100&search=名称' \
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/bd/material_brand_group?page=1&amp;page_size=100&amp;search=名称&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
