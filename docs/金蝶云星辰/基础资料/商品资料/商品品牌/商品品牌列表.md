---
title: "商品品牌列表 更新于2024-02-29 21:29 复制链接"
product: "金蝶云星辰"
category: "基础资料 > 商品资料 > 商品品牌 > 商品品牌列表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9c85b420712511eda0b33125447185ac"
last_update: "2024-02-29 21:29"
crawl_date: "2026-03-03"
---

# 商品品牌列表 更新于2024-02-29 21:29 复制链接

> 产品：金蝶云星辰 | 分类：基础资料 > 商品资料 > 商品品牌 > 商品品牌列表

商品品牌列表 更新于2024-02-29 21:29 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：获取商品品牌列表
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/bd/material_brand
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| parent            | array  | false | 品牌分类id           

#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/bd/material_brand?create_end_time=1234567890123&create_start_time=1234567890123&enable=1&modify_end_time=1234567890123&modify_start_time=1234567890123&page=1&page_size=100&parent=1' \
...
| name          | string | 品牌名称            
| number        | string | 编码              
| parent_id     | string | 品牌分类id          
| parent_name   | string | 品牌分类名称          
| parent_number | string | 品牌分类编码          
...
<li>用途说明：获取商品品牌列表</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/bd/material_brand</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/bd/material_brand?create_end_time=1234567890123&amp;create_start_time=1234567890123&amp;enable=1&amp;modify_end_time=1234567890123&amp;modify_start_time=1234567890123&amp;page=1&amp;page_size=100&amp;parent=1&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		...
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				...
				<span class="hljs-attr">&quot;name&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;品牌&quot;</span><span class="hljs-punctuation">,</span>
				...
				<span class="hljs-attr">&quot;parent_name&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;上级品牌&quot;</span><span class="hljs-punctuation">,</span>
