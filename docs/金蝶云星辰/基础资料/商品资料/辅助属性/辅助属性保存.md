---
title: "辅助属性保存 更新于2023-10-19 21:07 复制链接"
product: "金蝶云星辰"
category: "基础资料 > 商品资料 > 辅助属性 > 辅助属性保存"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9c0c6537712511eda0b3c72bbbaa1dd6"
last_update: "2023-10-19 21:07"
crawl_date: "2026-03-03"
---

# 辅助属性保存 更新于2023-10-19 21:07 复制链接

> 产品：金蝶云星辰 | 分类：基础资料 > 商品资料 > 辅助属性 > 辅助属性保存

辅助属性保存 更新于2023-10-19 21:07 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：辅助属性新增及修改。审核、删除等详见[通用操作接口](https://open.jdy.com/#/files/api/detail?index=2&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9e804b8c712511eda0b39f724d124b07)
- 请求方式：POST
...
| 参数名称        | 参数类型   | 是否必填  | 参数说明                             |
| --- | --- | --- | --- |
| group_id    | string | true  | 辅助属性分类id                         
| name        | string | true  | 辅助属性名称                           
| number      | string | true  | 辅助属性编码,不传递则由后台生成（不设置有编码规则和更新时必传） 
| parent_id   | string | true  | 辅助属性组id                          
| description | string | false | 备注                               
| id          | string | false | 辅助属性id（修改辅助属性时必填）                

#### 请求示例
```txt
curl --location --request  post 'https://api.kingdee.com/jdy/v2/bd/aux_attribute' \
...
<ul>
<li>用途说明：辅助属性新增及修改。审核、删除等详见<a href="https://open.jdy.com/#/files/api/detail?index=2&amp;categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&amp;id=9e804b8c712511eda0b39f724d124b07" target="_blank">通用操作接口</a></li>
<li>请求方式：POST</li>
...
<td>string</td>
<td>true</td>
<td>辅助属性编码,不传递则由后台生成（不设置有编码规则和更新时必传）</td>
</tr>
<tr>
<td>parent_id</td>
<td>string</td>
...
<td>string</td>
<td>false</td>
<td>辅助属性id（修改辅助属性时必填）</td>
</tr>
</tbody>
</table>
<h4><a id="_28"></a>请求示例</h4>
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/bd/aux_attribute&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
