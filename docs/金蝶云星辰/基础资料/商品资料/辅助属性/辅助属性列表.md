---
title: "辅助属性列表 更新于2023-12-08 11:09 复制链接"
product: "金蝶云星辰"
category: "基础资料 > 商品资料 > 辅助属性 > 辅助属性列表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9c0d2888712511eda0b3230eb9858a92"
last_update: "2023-12-08 11:09"
crawl_date: "2026-03-03"
---

# 辅助属性列表 更新于2023-12-08 11:09 复制链接

> 产品：金蝶云星辰 | 分类：基础资料 > 商品资料 > 辅助属性 > 辅助属性列表

辅助属性列表 更新于2023-12-08 11:09 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：获取辅助属性列表
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/bd/aux_attribute
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| group_id          | array  | false | 类别id              
| modify_end_time   | string | false | 修改时间-结束时间的时间戳(毫秒) 
| modify_start_time | string | false | 修改时间-开始时间的时间戳(毫秒) 
| name              | string | false | 类别名称              
| number            | string | false | 类别编码              
| page              | string | false | 当前页，默认1           
| page_size         | string | false | 每页显示条数默认10        
| search            | string | false | 按名称、编码模糊查询        

#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/bd/aux_attribute?create_end_time=1234567890123&create_start_time=1234567890123&enable=1&group_id=[]&modify_end_time=1234567890123&modify_start_time=1234567890123&name=类别&number=001&page=1&page_size=100&search=苹果' \
...
<li>用途说明：获取辅助属性列表</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/bd/aux_attribute</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/bd/aux_attribute?create_end_time=1234567890123&amp;create_start_time=1234567890123&amp;enable=1&amp;group_id=[]&amp;modify_end_time=1234567890123&amp;modify_start_time=1234567890123&amp;name=类别&amp;number=001&amp;page=1&amp;page_size=100&amp;search=苹果&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		...
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				...
				<span class="hljs-attr">&quot;parent&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;1&quot;</span>
			<span class="hljs-punctuation">}</span>
