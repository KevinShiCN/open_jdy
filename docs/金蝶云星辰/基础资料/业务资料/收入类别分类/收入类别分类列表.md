---
title: "收入类别分类列表 更新于2025-04-10 21:26 复制链接"
product: "金蝶云星辰"
category: "基础资料 > 业务资料 > 收入类别分类 > 收入类别分类列表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9b3251cd160c11f09fbd997d20119b74"
last_update: "2025-04-10 21:26"
crawl_date: "2026-03-03"
---

# 收入类别分类列表 更新于2025-04-10 21:26 复制链接

> 产品：金蝶云星辰 | 分类：基础资料 > 业务资料 > 收入类别分类 > 收入类别分类列表

收入类别分类列表 更新于2025-04-10 21:26 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：收入类别分类列表
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/bd/income_categorization
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| un_page   | string | false | 是否分页，1：不分页返回100条数据；不传默认分页 

#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/bd/income_categorization?enable=1&page=1&page_size=100&search=苹果&un_page=1' \
...
| --- | --- | --- |
| id     | string | 收入类别分类id 
| name   | string | 收入类别分类名称 
| number | string | 收入类别分类编码 
...
<li>用途说明：收入类别分类列表</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/bd/income_categorization</li>
</ul>
...
<td>string</td>
<td>false</td>
<td>是否分页，1：不分页返回100条数据；不传默认分页</td>
</tr>
</tbody>
</table>
<h4><a id="_27"></a>请求示例</h4>
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/bd/income_categorization?enable=1&amp;page=1&amp;page_size=100&amp;search=苹果&amp;un_page=1&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
