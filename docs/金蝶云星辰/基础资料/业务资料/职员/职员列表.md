---
title: "职员列表 更新于2024-11-07 21:52 复制链接"
product: "金蝶云星辰"
category: "基础资料 > 业务资料 > 职员 > 职员列表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9c583b6c712511eda0b3cdfb303d26af"
last_update: "2024-11-07 21:52"
crawl_date: "2026-03-03"
---

# 职员列表 更新于2024-11-07 21:52 复制链接

> 产品：金蝶云星辰 | 分类：基础资料 > 业务资料 > 职员 > 职员列表

职员列表 更新于2024-11-07 21:52 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：获取职员列表
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/bd/emp
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/bd/emp?create_end_time=1234567890123&create_start_time=1234567890123&dept_id=[]&enable=1&modify_end_time=1234567890123&modify_start_time=1234567890123&page=1&page_size=100&search=苹果' \
...
| id_number | string | 身份证号 [敏感数据解密](https://open.jdy.com/#/files/api/detail?id=d7046d818dc111ee860d0fedad361070&noside=true) 
...
<li>用途说明：获取职员列表</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/bd/emp</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/bd/emp?create_end_time=1234567890123&amp;create_start_time=1234567890123&amp;dept_id=[]&amp;enable=1&amp;modify_end_time=1234567890123&amp;modify_start_time=1234567890123&amp;page=1&amp;page_size=100&amp;search=苹果&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
...
<td>id_number</td>
<td>string</td>
<td>身份证号 <a href="https://open.jdy.com/#/files/api/detail?id=d7046d818dc111ee860d0fedad361070&amp;noside=true" target="_blank">敏感数据解密</a></td>
</tr>
<tr>
<td>mobile</td>
<td>string</td>
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		...
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				...
				<span class="hljs-attr">&quot;id_number&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;333321111111111111&quot;</span><span class="hljs-punctuation">,</span>
