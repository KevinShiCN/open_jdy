---
title: "辅助资料列表 更新于2025-09-25 21:18 复制链接"
product: "金蝶云星辰"
category: "基础资料 > 业务资料 > 辅助资料 > 辅助资料列表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9c1c6ad0712511eda0b36dcbf95b84fb"
last_update: "2025-09-25 21:18"
crawl_date: "2026-03-03"
---

# 辅助资料列表 更新于2025-09-25 21:18 复制链接

> 产品：金蝶云星辰 | 分类：基础资料 > 业务资料 > 辅助资料 > 辅助资料列表

辅助资料列表 更新于2025-09-25 21:18 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：获取辅助资料列表
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/bd/aux_info
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| group             | array  | false | 类别id（系统预置类别： 1-客户等级 2-交货方式 3-退货原因 4-其它入库类型 5-其它出库类型） 
| ids               | array  | false | 辅助资料id                                               
...
#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/bd/aux_info?create_end_time=1234567890123&create_start_time=1234567890123&enable=1&group=[]&ids=[]&modify_end_time=1234567890123&modify_start_time=1234567890123&name=名称&number=001&page=1&page_size=100&search=苹果' \
...
| group        | string | 类别id（系统预置类别： 1-客户等级 2-交货方式 3-退货原因 4-其它入库类型 5-其它出库类型） 
...
<li>用途说明：获取辅助资料列表</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/bd/aux_info</li>
</ul>
...
<td>array</td>
<td>false</td>
<td>类别id（系统预置类别： 1-客户等级 2-交货方式 3-退货原因 4-其它入库类型 5-其它出库类型）</td>
</tr>
<tr>
<td>ids</td>
<td>array</td>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/bd/aux_info?create_end_time=1234567890123&amp;create_start_time=1234567890123&amp;enable=1&amp;group=[]&amp;ids=[]&amp;modify_end_time=1234567890123&amp;modify_start_time=1234567890123&amp;name=名称&amp;number=001&amp;page=1&amp;page_size=100&amp;search=苹果&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		...
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				...
				<span class="hljs-attr">&quot;group&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;1&quot;</span><span class="hljs-punctuation">,</span>
				<span class="hljs-attr">&quot;group_name&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;收入类别&quot;</span><span class="hljs-punctuation">,</span>
				<span class="hljs-attr">&quot;group_number&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;0001&quot;</span><span class="hljs-punctuation">,</span>
