---
title: "结算期限保存 更新于2023-10-19 21:07 复制链接"
product: "金蝶云星辰"
category: "基础资料 > 业务资料 > 结算周期 > 结算期限保存"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9cc30b5d712511eda0b365f118a24484"
last_update: "2023-10-19 21:07"
crawl_date: "2026-03-03"
---

# 结算期限保存 更新于2023-10-19 21:07 复制链接

> 产品：金蝶云星辰 | 分类：基础资料 > 业务资料 > 结算周期 > 结算期限保存

结算期限保存 更新于2023-10-19 21:07 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
...
| --- | --- | --- | --- |
| name            | string | true  | 名称                      
| before_days     | string | false | 月结期限结算多少天，type为2时传递     
| enable          | string | false | 状态，1代表启用，0代表禁用，默认1      
| id              | string | false | 新增不填，更新时必填（id为空时代表新增单据） 
| month_check_day | string | false | 对账日                     
| month_payday    | string | false | 月结期限每月结算日期，type为2时传递    
| stand_days      | string | false | 收款期限，type为1时传递          
...
<ul>
<li>用途说明：结算期限新增及修改。审核、删除等详见<a href="https://open.jdy.com/#/files/api/detail?index=2&amp;categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&amp;id=9e804b8c712511eda0b39f724d124b07" target="_blank">通用操作接口</a></li>
<li>请求方式：POST</li>
...
<td>string</td>
<td>false</td>
<td>月结期限结算多少天，type为2时传递</td>
</tr>
<tr>
<td>enable</td>
<td>string</td>
<td>false</td>
<td>状态，1代表启用，0代表禁用，默认1</td>
</tr>
<tr>
<td>id</td>
<td>string</td>
...
<td>string</td>
<td>false</td>
<td>月结期限每月结算日期，type为2时传递</td>
</tr>
<tr>
<td>stand_days</td>
<td>string</td>
<td>false</td>
<td>收款期限，type为1时传递</td>
</tr>
<tr>
<td>type</td>
<td>string</td>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/bd/settling_term&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
