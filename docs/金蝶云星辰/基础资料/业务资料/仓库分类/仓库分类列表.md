---
title: "仓库分类列表 更新于2024-06-20 21:38 复制链接"
product: "金蝶云星辰"
category: "基础资料 > 业务资料 > 仓库分类 > 仓库分类列表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9ce2a15a712511eda0b3771e631d446b"
last_update: "2024-06-20 21:38"
crawl_date: "2026-03-03"
---

# 仓库分类列表 更新于2024-06-20 21:38 复制链接

> 产品：金蝶云星辰 | 分类：基础资料 > 业务资料 > 仓库分类 > 仓库分类列表

仓库分类列表 更新于2024-06-20 21:38 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
...
| parent            | array   | false | 父级id，全部：-1        
| search            | string  | false | 模糊搜索-名称           

#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/bd/store_group?create_end_time=1234567890123&create_start_time=1234567890123&level=-1&modify_end_time=1234567890123&modify_start_time=1234567890123&page=1&page_size=100&parent=[]&search=苹果' \
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/bd/store_group?create_end_time=1234567890123&amp;create_start_time=1234567890123&amp;level=-1&amp;modify_end_time=1234567890123&amp;modify_start_time=1234567890123&amp;page=1&amp;page_size=100&amp;parent=[]&amp;search=苹果&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
