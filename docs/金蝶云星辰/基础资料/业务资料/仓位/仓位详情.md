---
title: "仓位详情 更新于2023-10-19 21:07 复制链接"
product: "金蝶云星辰"
category: "基础资料 > 业务资料 > 仓位 > 仓位详情"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9cc77831712511eda0b3e1feed0061eb"
last_update: "2023-10-19 21:07"
crawl_date: "2026-03-03"
---

# 仓位详情 更新于2023-10-19 21:07 复制链接

> 产品：金蝶云星辰 | 分类：基础资料 > 业务资料 > 仓位 > 仓位详情

仓位详情 更新于2023-10-19 21:07 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：获取仓位详情
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/bd/space_detail
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/bd/space_detail?id=1&number=001' \
...
<li>用途说明：获取仓位详情</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/bd/space_detail</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/bd/space_detail?id=1&amp;number=001&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
...
<pre><div class="hljs"><code class="lang-json"><span class="hljs-punctuation">{</span>
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		...
		<span class="hljs-attr">&quot;stock_id&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;1&quot;</span>
