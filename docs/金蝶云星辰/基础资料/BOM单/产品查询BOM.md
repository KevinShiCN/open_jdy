---
title: "产品查询BOM 更新于2024-01-17 15:16 复制链接"
product: "金蝶云星辰"
category: "基础资料 > BOM单 > 产品查询BOM"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=774dac6eb08211eeaee3b95748117ca8"
last_update: "2024-01-17 15:16"
crawl_date: "2026-03-03"
---

# 产品查询BOM 更新于2024-01-17 15:16 复制链接

> 产品：金蝶云星辰 | 分类：基础资料 > BOM单 > 产品查询BOM

产品查询BOM 更新于2024-01-17 15:16 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：查询BOM
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/bd/bom_query
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| 参数名称        | 参数类型   | 是否必填  | 参数说明          |
| --- | --- | --- | --- |
| material_id | string | true  | 产品ID          
| aux_prop_id | string | false | 辅助属性ID 辅助商品必录 
| page        | string | false | 当前页，默认1       
| page_size   | string | false | 每页显示条数默认20    
| search      | string | false | 模糊搜索-编码       

#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/bd/bom_query?material_id=10&aux_prop_id=10&page=1&page_size=100&search=BOM001' \
...
<li>用途说明：查询BOM</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/bd/bom_query</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/bd/bom_query?material_id=10&amp;aux_prop_id=10&amp;page=1&amp;page_size=100&amp;search=BOM001&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		...
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				...
				<span class="hljs-attr">&quot;number&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;BOM123&quot;</span>
			<span class="hljs-punctuation">}</span>
