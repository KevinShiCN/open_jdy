---
title: "科目类别列表 更新于2023-06-01 10:34 复制链接"
product: "金蝶云星辰"
category: "基础资料 > 财务资料 > 科目类别 > 科目类别列表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9d05e0df712511eda0b3870ee2bcafe2"
last_update: "2023-06-01 10:34"
crawl_date: "2026-03-03"
---

# 科目类别列表 更新于2023-06-01 10:34 复制链接

> 产品：金蝶云星辰 | 分类：基础资料 > 财务资料 > 科目类别 > 科目类别列表

科目类别列表 更新于2023-06-01 10:34 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：获取科目类别列表
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/fi/account_type
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
<li>用途说明：获取科目类别列表</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/fi/account_type</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/fi/account_type
</code></div></pre>
...
<tr>
<td>rows</td>
<td>List &lt;AccountTypeVO&gt;</td>
<td>列表</td>
</tr>
</tbody>
</table>
<p><strong>AccountTypeVO</strong></p>
<table>
<thead>
<tr>
<th>参数名称</th>
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		...
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				...
				<span class="hljs-attr">&quot;number&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;190101&quot;</span>
			<span class="hljs-punctuation">}</span>
		<span class="hljs-punctuation">]</span>
