---
title: "账户保存 更新于2024-08-23 16:52 复制链接"
product: "金蝶云星辰"
category: "基础资料 > 财务资料 > 账户管理 > 账户保存"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9cb4b377712511eda0b3c1585d77e17d"
last_update: "2024-08-23 16:52"
crawl_date: "2026-03-03"
---

# 账户保存 更新于2024-08-23 16:52 复制链接

> 产品：金蝶云星辰 | 分类：基础资料 > 财务资料 > 账户管理 > 账户保存

账户保存 更新于2024-08-23 16:52 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：结算账户新增及修改。审核、删除等详见[通用操作接口](https://open.jdy.com/#/files/api/detail?index=2&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9e804b8c712511eda0b39f724d124b07)
- 请求方式：POST
...
| 参数名称            | 参数类型    | 是否必填  | 参数说明                               |
| --- | --- | --- | --- |
| currency_number | string  | true  | 币别,多个币别使用英文逗号隔开                    
| name            | string  | true  | 名称                                 
| number          | string  | true  | 编码                                 
| account         | string  | false | 卡号                                 
| account_name    | string  | false | 开户名                                
| id              | string  | false | 新增不填，更新时必填（id为空时代表新增单据）            
| ignore_warn     | boolean | false | 是否忽略告警信息(如：单价为0)保存，true:忽略，默认false 
| is_default      | boolean | false | 是否默认结算账户                           
| opening_bank    | string  | false | 开户行                                
| remark          | string  | false | 备注                                 

#### 请求示例
```txt
curl --location --request  post 'https://api.kingdee.com/jdy/v2/bd/settlement_account' \
...
<ul>
<li>用途说明：结算账户新增及修改。审核、删除等详见<a href="https://open.jdy.com/#/files/api/detail?index=2&amp;categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&amp;id=9e804b8c712511eda0b39f724d124b07" target="_blank">通用操作接口</a></li>
<li>请求方式：POST</li>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/bd/settlement_account&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
