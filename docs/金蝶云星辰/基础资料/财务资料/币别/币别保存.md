---
title: "币别保存 更新于2023-10-19 21:07 复制链接"
product: "金蝶云星辰"
category: "基础资料 > 财务资料 > 币别 > 币别保存"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9c2f7dab712511eda0b385805025f6f1"
last_update: "2023-10-19 21:07"
crawl_date: "2026-03-03"
---

# 币别保存 更新于2023-10-19 21:07 复制链接

> 产品：金蝶云星辰 | 分类：基础资料 > 财务资料 > 币别 > 币别保存

币别保存 更新于2023-10-19 21:07 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
...
| 参数名称            | 参数类型    | 是否必填  | 参数说明                       |
| --- | --- | --- | --- |
| convert_mode    | string  | true  | 折算方式，1原币*汇率=本位币，2原币/汇率=本位币 
| exc_type        | string  | true  | =汇率类型，1：固定汇率，2：浮动汇率        
| name            | string  | true  | 名称                         
| number          | string  | true  | 编码                         
| rate            | string  | true  | 税率                         
| amt_precision   | string  | false | 金额小数位                      
| description     | string  | false | 描述                         
| enable          | integer | false | 状态(1:启用 0:禁用 -1：不限)        
| id              | string  | false | 新增不填，更新时必填（id为空时代表新增单据）    
| price_precision | string  | false | 单价小数位                      
...
<ul>
<li>用途说明：币别新增及修改。审核、删除等详见<a href="https://open.jdy.com/#/files/api/detail?index=2&amp;categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&amp;id=9e804b8c712511eda0b39f724d124b07" target="_blank">通用操作接口</a></li>
<li>请求方式：POST</li>
...
<td>string</td>
<td>true</td>
<td>折算方式，1原币*汇率=本位币，2原币/汇率=本位币</td>
</tr>
<tr>
<td>exc_type</td>
<td>string</td>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/bd/currency&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
