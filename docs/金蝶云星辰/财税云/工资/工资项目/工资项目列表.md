---
title: "工资项目列表 更新于2023-10-19 21:07 复制链接"
product: "金蝶云星辰"
category: "财税云 > 工资 > 工资项目 > 工资项目列表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=7431c228e4cd11ed8408b3488e4b6d5a"
last_update: "2023-10-19 21:07"
crawl_date: "2026-03-03"
---

# 工资项目列表 更新于2023-10-19 21:07 复制链接

> 产品：金蝶云星辰 | 分类：财税云 > 工资 > 工资项目 > 工资项目列表

工资项目列表 更新于2023-10-19 21:07 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：获取工资项目列表
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/fi/sa_item
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| 参数名称   | 参数类型   | 是否必填  | 参数说明   |
| --- | --- | --- | --- |
| search | string | false | 模糊查询条件 

#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/fi/sa_item?search=名称' \
...
<li>用途说明：获取工资项目列表</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/fi/sa_item</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/fi/sa_item?search=名称&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		...
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				...
				<span class="hljs-attr">&quot;number&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;002&quot;</span>
			<span class="hljs-punctuation">}</span>
