---
title: "工资项目保存 更新于2023-05-18 20:54 复制链接"
product: "金蝶云星辰"
category: "财税云 > 工资 > 工资项目 > 工资项目保存"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=742fc657e4cd11ed84084332fa2ac2a0"
last_update: "2023-05-18 20:54"
crawl_date: "2026-03-03"
---

# 工资项目保存 更新于2023-05-18 20:54 复制链接

> 产品：金蝶云星辰 | 分类：财税云 > 工资 > 工资项目 > 工资项目保存

工资项目保存 更新于2023-05-18 20:54 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
...
| 参数名称      | 参数类型    | 是否必填  | 参数说明              |
| --- | --- | --- | --- |
| data_type | integer | true  | 数据类型（1数值 2文本 4日期） 
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/fi/sa_item&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
