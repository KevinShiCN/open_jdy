---
title: "存放地点列表 更新于2023-09-01 09:39 复制链接"
product: "金蝶云星辰"
category: "财税云 > 资产 > 资产资料 > 存放地点 > 存放地点列表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=72ba7c7fcf0a11edbe4cc10a50ef75c3"
last_update: "2023-09-01 09:39"
crawl_date: "2026-03-03"
---

# 存放地点列表 更新于2023-09-01 09:39 复制链接

> 产品：金蝶云星辰 | 分类：财税云 > 资产 > 资产资料 > 存放地点 > 存放地点列表

存放地点列表 更新于2023-09-01 09:39 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：获取存放地点列表
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/fi/fa_location
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
<li>用途说明：获取存放地点列表</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/fi/fa_location</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/fi/fa_location?page=1&amp;page_size=100&amp;search=001&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		...
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				...
				<span class="hljs-attr">&quot;note&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot; &quot;</span><span class="hljs-punctuation">,</span>
