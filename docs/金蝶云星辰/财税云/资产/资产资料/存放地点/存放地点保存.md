---
title: "存放地点保存 更新于2023-10-19 21:07 复制链接"
product: "金蝶云星辰"
category: "财税云 > 资产 > 资产资料 > 存放地点 > 存放地点保存"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=72b7211ecf0a11edbe4c5f59f3b75cfd"
last_update: "2023-10-19 21:07"
crawl_date: "2026-03-03"
---

# 存放地点保存 更新于2023-10-19 21:07 复制链接

> 产品：金蝶云星辰 | 分类：财税云 > 资产 > 资产资料 > 存放地点 > 存放地点保存

存放地点保存 更新于2023-10-19 21:07 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：存放地点保存
- 请求方式：POST
- 请求地址：https://api.kingdee.com/jdy/v2/fi/fa_location_save
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| 参数名称      | 参数类型   | 是否必填   | 参数说明               |
| --- | --- | --- | --- |
| name      | string | false  | 存放地点名              
| note      | string | false  | 备注                 
| number    | string | false  | 存放地点编码             
| parent_id | string | false  | 上级类别ID             
| id        | string |  false | id（修改时必填，新增保存返回id） 

#### 请求示例
```txt
curl --location --request  post 'https://api.kingdee.com/jdy/v2/fi/fa_location_save' \
...
<li>用途说明：存放地点保存</li>
<li>请求方式：POST</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/fi/fa_location_save</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/fi/fa_location_save&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
