---
title: "变动方式保存 更新于2023-10-19 21:07 复制链接"
product: "金蝶云星辰"
category: "财税云 > 资产 > 资产资料 > 变动方式 > 变动方式保存"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=72847853cf0a11edbe4c6be54cd43612"
last_update: "2023-10-19 21:07"
crawl_date: "2026-03-03"
---

# 变动方式保存 更新于2023-10-19 21:07 复制链接

> 产品：金蝶云星辰 | 分类：财税云 > 资产 > 资产资料 > 变动方式 > 变动方式保存

变动方式保存 更新于2023-10-19 21:07 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：获取变动方式保存
- 请求方式：POST
- 请求地址：https://api.kingdee.com/jdy/v2/fi/fa_altermode_save
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| 参数名称     | 参数类型   | 是否必填   | 参数说明               |
| --- | --- | --- | --- |
| group_id | string | true   | 变动方式类别id           
| name     | string | true   | 变动方式名称             
| number   | string | true   | 变动方式编码             
| note     | string | false  | 备注                 
| id       | string |  false | id（修改时必填，新增保存返回id） 

#### 请求示例
```txt
curl --location --request  post 'https://api.kingdee.com/jdy/v2/fi/fa_altermode_save' \
...
<li>用途说明：获取变动方式保存</li>
<li>请求方式：POST</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/fi/fa_altermode_save</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/fi/fa_altermode_save&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
