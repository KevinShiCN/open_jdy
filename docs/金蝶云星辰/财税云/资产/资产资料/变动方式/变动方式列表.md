---
title: "变动方式列表 更新于2023-10-19 21:07 复制链接"
product: "金蝶云星辰"
category: "财税云 > 资产 > 资产资料 > 变动方式 > 变动方式列表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=728e8a74cf0a11edbe4c3138f96d82e7"
last_update: "2023-10-19 21:07"
crawl_date: "2026-03-03"
---

# 变动方式列表 更新于2023-10-19 21:07 复制链接

> 产品：金蝶云星辰 | 分类：财税云 > 资产 > 资产资料 > 变动方式 > 变动方式列表

变动方式列表 更新于2023-10-19 21:07 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：获取变动方式列表
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/fi/fa_altermode
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| page_size | string | false | 每页显示条数默认100    
| search    | string | false | 模糊搜索，支持单据编号、备注 

#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/fi/fa_altermode?page=1&page_size=100&search=001' \
...
<li>用途说明：获取变动方式列表</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/fi/fa_altermode</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/fi/fa_altermode?page=1&amp;page_size=100&amp;search=001&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
