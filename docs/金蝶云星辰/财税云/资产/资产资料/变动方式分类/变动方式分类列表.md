---
title: "变动方式分类列表 更新于2023-10-19 21:07 复制链接"
product: "金蝶云星辰"
category: "财税云 > 资产 > 资产资料 > 变动方式分类 > 变动方式分类列表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=72c0be11cf0a11edbe4c219cb82b2d31"
last_update: "2023-10-19 21:07"
crawl_date: "2026-03-03"
---

# 变动方式分类列表 更新于2023-10-19 21:07 复制链接

> 产品：金蝶云星辰 | 分类：财税云 > 资产 > 资产资料 > 变动方式分类 > 变动方式分类列表

变动方式分类列表 更新于2023-10-19 21:07 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：变动方式分类列表
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/fi/fa_modegroup
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| page_size | string | false | 每页显示条数默认100,接口需要同步支持 

#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/fi/fa_modegroup?page=1&page_size=100' \
...
<li>用途说明：变动方式分类列表</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/fi/fa_modegroup</li>
</ul>
...
<td>string</td>
<td>false</td>
<td>每页显示条数默认100,接口需要同步支持</td>
</tr>
</tbody>
</table>
<h4><a id="_24"></a>请求示例</h4>
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/fi/fa_modegroup?page=1&amp;page_size=100&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
