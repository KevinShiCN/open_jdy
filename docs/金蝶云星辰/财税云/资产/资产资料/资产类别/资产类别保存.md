---
title: "资产类别保存 更新于2023-10-19 21:07 复制链接"
product: "金蝶云星辰"
category: "财税云 > 资产 > 资产资料 > 资产类别 > 资产类别保存"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=72b1a2dccf0a11edbe4cffff6afa12fa"
last_update: "2023-10-19 21:07"
crawl_date: "2026-03-03"
---

# 资产类别保存 更新于2023-10-19 21:07 复制链接

> 产品：金蝶云星辰 | 分类：财税云 > 资产 > 资产资料 > 资产类别 > 资产类别保存

资产类别保存 更新于2023-10-19 21:07 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：资产类别保存
- 请求方式：POST
- 请求地址：https://api.kingdee.com/jdy/v2/fi/fa_group_save
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| depr_method_id | string | false  | 折旧方法ID                  
| depr_policy    | string | false  | 折旧政策（1-新增当期计提，2-清理当期计提） 
| note           | string | false  | 备注                      
| number_rule    | string | false  | 卡片编码前缀                  
| parent_id      | string | false  | 上级类别ID                  
| periods        | string | false  | 预计使用年限                  
| residue_rate   | string | false  | 净残值率（%）                 
...
<li>用途说明：资产类别保存</li>
<li>请求方式：POST</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/fi/fa_group_save</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/fi/fa_group_save&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
