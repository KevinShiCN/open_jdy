---
title: "资产类别列表 更新于2023-09-01 09:39 复制链接"
product: "金蝶云星辰"
category: "财税云 > 资产 > 资产资料 > 资产类别 > 资产类别列表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=72af31dbcf0a11edbe4ccb033c5d1536"
last_update: "2023-09-01 09:39"
crawl_date: "2026-03-03"
---

# 资产类别列表 更新于2023-09-01 09:39 复制链接

> 产品：金蝶云星辰 | 分类：财税云 > 资产 > 资产资料 > 资产类别 > 资产类别列表

资产类别列表 更新于2023-09-01 09:39 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：获取资产类别列表
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/fi/fa_group
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/fi/fa_group?page=1&page_size=100&search=001' \
...
| depr_policy        | string  | 折旧政策（1-新增当期计提，2-清理当期计提） 
| is_leaf            | boolean | 是否明细（是-true， 否-false）   
| level              | string  | 级次（1-n）                 
| name               | string  | 名字                      
| note               | string  | 备注                      
| number             | string  | 编码                      
| number_rule        | string  | 卡片编码前缀                  
| parent_id          | string  | 属性组id                   
| parent_name        | string  | 上级类别名称（没有上级不返回）c=类别一    
| parent_number      | string  | 属性组编码                   
| periods            | string  | 预计使用期间数                 
| residue_rate       | string  | 净残值率（%）                 
| years              | string  | 预计使用年限                  
...
<li>用途说明：获取资产类别列表</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/fi/fa_group</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/fi/fa_group?page=1&amp;page_size=100&amp;search=001&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
...
<td>depr_policy</td>
<td>string</td>
<td>折旧政策（1-新增当期计提，2-清理当期计提）</td>
</tr>
<tr>
<td>is_leaf</td>
<td>boolean</td>
<td>是否明细（是-true， 否-false）</td>
</tr>
<tr>
<td>level</td>
<td>string</td>
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		...
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				...
				<span class="hljs-attr">&quot;depr_method_name&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;1&quot;</span><span class="hljs-punctuation">,</span>
				...
				<span class="hljs-attr">&quot;depr_policy&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;1&quot;</span><span class="hljs-punctuation">,</span>
				...
				<span class="hljs-attr">&quot;level&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;1 &quot;</span><span class="hljs-punctuation">,</span>
				...
				<span class="hljs-attr">&quot;note&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;备注 &quot;</span><span class="hljs-punctuation">,</span>
				...
				<span class="hljs-attr">&quot;number_rule&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;1&quot;</span><span class="hljs-punctuation">,</span>
				...
				<span class="hljs-attr">&quot;parent_name&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-keyword">null</span><span class="hljs-punctuation">,</span>
				...
				<span class="hljs-attr">&quot;periods&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;1&quot;</span><span class="hljs-punctuation">,</span>
				<span class="hljs-attr">&quot;residue_rate&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;100&quot;</span><span class="hljs-punctuation">,</span>
				<span class="hljs-attr">&quot;years&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;1&quot;</span>
			<span class="hljs-punctuation">}</span>
