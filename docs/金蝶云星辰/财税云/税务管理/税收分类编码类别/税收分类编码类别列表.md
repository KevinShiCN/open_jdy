---
title: "税收分类编码类别列表 更新于2024-05-29 09:53 复制链接"
product: "金蝶云星辰"
category: "财税云 > 税务管理 > 税收分类编码类别 > 税收分类编码类别列表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=24aa4400f80411ee8bba2fd3ae34e0a5"
last_update: "2024-05-29 09:53"
crawl_date: "2026-03-03"
---

# 税收分类编码类别列表 更新于2024-05-29 09:53 复制链接

> 产品：金蝶云星辰 | 分类：财税云 > 税务管理 > 税收分类编码类别 > 税收分类编码类别列表

税收分类编码类别列表 更新于2024-05-29 09:53 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：税收分类编码类别列表
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/fi/tax_category_type
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
<ul>
<li>用途说明：税收分类编码类别列表</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/fi/tax_category_type</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/fi/tax_category_type?pid=1&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				...
				<span class="hljs-attr">&quot;remark&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;这里是备注&quot;</span>
			<span class="hljs-punctuation">}</span>
		<span class="hljs-punctuation">]</span>
