---
title: "销售出库单查询发票信息 更新于1970-01-01 08:00 复制链接"
product: "金蝶云星辰"
category: "财税云 > 税务管理 > 开票管理 > 销售出库单查询发票信息"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=a863f5d3758811efb84d63f2856478b5"
last_update: "1970-01-01 08:00"
crawl_date: "2026-03-03"
---

# 销售出库单查询发票信息 更新于1970-01-01 08:00 复制链接

> 产品：金蝶云星辰 | 分类：财税云 > 税务管理 > 开票管理 > 销售出库单查询发票信息

销售出库单查询发票信息 更新于1970-01-01 08:00 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：销售出库单查询发票信息
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/fp/invoice_kp_query
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| 参数名称    | 参数类型   | 是否必填 | 参数说明    |
| --- | --- | --- | --- |
| bill_no | string | true | 销售出库单编码 

#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/fp/invoice_kp_query?bill_no=XSFP-20240716-00001' \
...
<ul>
<li>用途说明：销售出库单查询发票信息</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/fp/invoice_kp_query</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/fp/invoice_kp_query?bill_no=XSFP-20240716-00001&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				<span class="hljs-attr">&quot;invoice_date&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;2021-01-01&quot;</span><span class="hljs-punctuation">,</span>
				<span class="hljs-attr">&quot;invoice_number&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;发票编码&quot;</span>
			<span class="hljs-punctuation">}</span>
		<span class="hljs-punctuation">]</span>
