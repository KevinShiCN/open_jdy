---
title: "凭证冲销 更新于2023-04-19 13:35 复制链接"
product: "金蝶云星辰"
category: "财税云 > 凭证 > 凭证冲销"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9d22699c712511eda0b387810e390602"
last_update: "2023-04-19 13:35"
crawl_date: "2026-03-03"
---

# 凭证冲销 更新于2023-04-19 13:35 复制链接

> 产品：金蝶云星辰 | 分类：财税云 > 凭证 > 凭证冲销

凭证冲销 更新于2023-04-19 13:35 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：冲销凭证
- 请求方式：POST
- 请求地址：https://api.kingdee.com/jdy/v2/fi/voucher_reverse
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| 参数名称 | 参数类型          | 是否必填 | 参数说明 |
| --- | --- | --- | --- |
| ids  | List <string> | true | id数组 

#### 请求示例
```txt
curl --location --request  post 'https://api.kingdee.com/jdy/v2/fi/voucher_reverse' \
...
| id                 | string | 凭证ID       
| message            | string | 信息提示       
| reverse_voucher_id | string | 新生成的冲销凭证ID 
...
<li>用途说明：冲销凭证</li>
<li>请求方式：POST</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/fi/voucher_reverse</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/fi/voucher_reverse&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				...
				<span class="hljs-attr">&quot;message&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;无&quot;</span><span class="hljs-punctuation">,</span>
				<span class="hljs-attr">&quot;reverse_voucher_id&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;1&quot;</span>
			<span class="hljs-punctuation">}</span>
		<span class="hljs-punctuation">]</span>
