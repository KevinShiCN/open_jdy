---
title: "凭证附件上传 更新于2024-05-16 13:51 复制链接"
product: "金蝶云星辰"
category: "财税云 > 凭证 > 凭证附件 > 凭证附件上传"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=1c54d560b43211eeaee3bdbebbdfe959"
last_update: "2024-05-16 13:51"
crawl_date: "2026-03-03"
---

# 凭证附件上传 更新于2024-05-16 13:51 复制链接

> 产品：金蝶云星辰 | 分类：财税云 > 凭证 > 凭证附件 > 凭证附件上传

凭证附件上传 更新于2024-05-16 13:51 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：凭证附件上传
- 请求方式：POST
- 请求地址：https://api.kingdee.com/jdy/v2/fi/voucher_attachment_upload
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
```json
{
    ...
    "data": [
        {
            "filepaththumbnail": "https://tf.jdy.com/fileserver//jdyattachmentimage/xxx/xxx/xxx/202401/gl/gl_voucherattach/xxx/attachments/xxx/xxx.txt",
            "period": 202102,
            "filename": "111.txt",
            "filepath": "https://tf.jdy.com/fileserver//jdyattachmentimage/xxx/xxx/xxx/202401/gl/gl_voucherattach/xxx/attachments/xxx/111.txt",
            "id": xxx,
            "filesize": 2255,
            "fileType": "txt"
        }
...
<li>用途说明：凭证附件上传</li>
<li>请求方式：POST</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/fi/voucher_attachment_upload</li>
</ul>
...
<td>File</td>
<td>true</td>
<td>选中上传的文件（单个5m以内，最多每次上传1个文件，文件名只能包含字母数字且需要带文件后缀）</td>
</tr>
</tbody>
</table>
<h4><a id="_23"></a>请求示例</h4>
<pre><div class="hljs"><code class="lang-txt">curl --location --request POST &#x27;https://api.kingdee.com/jdy/v2/fi/voucher_attachment_upload&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
...
<td>errorCode</td>
<td>string</td>
<td>返回码，调用成功时为success</td>
</tr>
<tr>
<td>message</td>
<td>string</td>
<td>返回信息，调用失败时会返回具体信息</td>
</tr>
<tr>
<td>data</td>
<td>Data</td>
...
<pre><div class="hljs"><code class="lang-json"><span class="hljs-punctuation">{</span>
    ...
    <span class="hljs-attr">&quot;reachPlugin&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-keyword">true</span><span class="hljs-punctuation">,</span>
    <span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">[</span>
        <span class="hljs-punctuation">{</span>
            <span class="hljs-attr">&quot;filepaththumbnail&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-string">&quot;https://tf.jdy.com/fileserver//jdyattachmentimage/xxx/xxx/xxx/202401/gl/gl_voucherattach/xxx/attachments/xxx/xxx.txt&quot;</span><span class="hljs-punctuation">,</span>
            <span class="hljs-attr">&quot;period&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-number">202102</span><span class="hljs-punctuation">,</span>
            <span class="hljs-attr">&quot;filename&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-string">&quot;111.txt&quot;</span><span class="hljs-punctuation">,</span>
            <span class="hljs-attr">&quot;filepath&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-string">&quot;https://tf.jdy.com/fileserver//jdyattachmentimage/xxx/xxx/xxx/202401/gl/gl_voucherattach/xxx/attachments/xxx/111.txt&quot;</span><span class="hljs-punctuation">,</span>
            <span class="hljs-attr">&quot;id&quot;</span><span class="hljs-punctuation">:</span> xxx<span class="hljs-punctuation">,</span>
            <span class="hljs-attr">&quot;filesize&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-number">2255</span><span class="hljs-punctuation">,</span>
            <span class="hljs-attr">&quot;fileType&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-string">&quot;txt&quot;</span>
        <span class="hljs-punctuation">}</span>
    <span class="hljs-punctuation">]</span><span class="hljs-punctuation">,</span>
    <span class="hljs-attr">&quot;errorCode&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-string">&quot;success&quot;</span>
<span class="hljs-punctuation">}</span>
</code></div></pre>
<h4><a id="_77"></a>返回码</h4>
<table>
<thead>
<tr>
<th>返回码</th>
