---
title: "外部单据分类列表 更新于2023-04-19 13:35 复制链接"
product: "金蝶云星辰"
category: "财税云 > 凭证 > 外部单据分类 > 外部单据分类列表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9d329644712511eda0b3f38d90b2f8d7"
last_update: "2023-04-19 13:35"
crawl_date: "2026-03-03"
---

# 外部单据分类列表 更新于2023-04-19 13:35 复制链接

> 产品：金蝶云星辰 | 分类：财税云 > 凭证 > 外部单据分类 > 外部单据分类列表

外部单据分类列表 更新于2023-04-19 13:35 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
...
| 参数名称      | 参数类型   | 是否必填  | 参数说明       |
| --- | --- | --- | --- |
| ids       | array  | false | 外部单据分类id   
| name      | string | false | 名称         
| number    | string | false | 外部单据分类编码   
| page      | string | false | 当前页，默认1    
| page_size | string | false | 每页显示条数默认10 

#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/fi/virtual_type?ids=[]&name=名称&number=001&page=1&page_size=100' \
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/fi/virtual_type?ids=[]&amp;name=名称&amp;number=001&amp;page=1&amp;page_size=100&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
