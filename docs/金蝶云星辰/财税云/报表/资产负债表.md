---
title: "资产负债表 更新于2023-12-29 09:32 复制链接"
product: "金蝶云星辰"
category: "财税云 > 报表 > 资产负债表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=af367600a58111ee860d6f088f6459df"
last_update: "2023-12-29 09:32"
crawl_date: "2026-03-03"
---

# 资产负债表 更新于2023-12-29 09:32 复制链接

> 产品：金蝶云星辰 | 分类：财税云 > 报表 > 资产负债表

资产负债表 更新于2023-12-29 09:32 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：查询资产负债表
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/fi/balancesheet
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/fi/balancesheet?period=202001' \
...
| type             | string | 项目类别(type=1，资产；type=2,负债；type=3，所有者权益) 
| year_begin_value | string | 年初余额                                   
| year_end_value   | string | 期末余额                                   
...
<li>用途说明：查询资产负债表</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/fi/balancesheet</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/fi/balancesheet?period=202001&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
...
<tr>
<td>rows</td>
<td>List &lt;BalanceSheet&gt;</td>
<td>数据行</td>
</tr>
</tbody>
</table>
<p><strong>BalanceSheet</strong></p>
<table>
<thead>
<tr>
<th>参数名称</th>
...
<td>type</td>
<td>string</td>
<td>项目类别(type=1，资产；type=2,负债；type=3，所有者权益)</td>
</tr>
<tr>
<td>year_begin_value</td>
<td>string</td>
<td>年初余额</td>
</tr>
<tr>
<td>year_end_value</td>
<td>string</td>
<td>期末余额</td>
</tr>
</tbody>
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				...
				<span class="hljs-attr">&quot;year_begin_value&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;100&quot;</span><span class="hljs-punctuation">,</span>
				<span class="hljs-attr">&quot;year_end_value&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;11&quot;</span>
			<span class="hljs-punctuation">}</span>
		<span class="hljs-punctuation">]</span>
