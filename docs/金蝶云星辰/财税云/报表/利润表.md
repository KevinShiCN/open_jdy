---
title: "利润表 更新于2023-04-19 13:35 复制链接"
product: "金蝶云星辰"
category: "财税云 > 报表 > 利润表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9d11eed5712511eda0b33734e5d25d3e"
last_update: "2023-04-19 13:35"
crawl_date: "2026-03-03"
---

# 利润表 更新于2023-04-19 13:35 复制链接

> 产品：金蝶云星辰 | 分类：财税云 > 报表 > 利润表

利润表 更新于2023-04-19 13:35 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：获取利润表
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/fi/profit_report
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| 参数名称   | 参数类型   | 是否必填 | 参数说明   |
| --- | --- | --- | --- |
| period | string | true | 结束年度期间 

#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/fi/profit_report?period=202001' \
...
| 参数名称 | 参数类型                   | 参数说明 |
| --- | --- | --- |
| rows | List <ProfitDataReply> | 数据行  

**ProfitDataReply**
| 参数名称             | 参数类型    | 参数说明                                |
| --- | --- | --- |
| id               | string  | id                                  
| current_amount   | string  | 本期（本月）金额                            
| index            | string  | 行次                                  
| last_year_amount | string  | 上期（去年同期）金额                          
| level            | integer | 级次                                  
| name             | string  | 名称                                  
| parent_id        | string  | 父级id                                
| type             | string  | 类型1-收入2-成本3-税金及附加4-所得税5-净利润6-费用0-忽略 
| year_amount      | string  | 本年累计金额                              
...
<li>用途说明：获取利润表</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/fi/profit_report</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/fi/profit_report?period=202001&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
...
<tr>
<td>rows</td>
<td>List &lt;ProfitDataReply&gt;</td>
<td>数据行</td>
</tr>
</tbody>
</table>
<p><strong>ProfitDataReply</strong></p>
<table>
<thead>
<tr>
<th>参数名称</th>
...
<td>type</td>
<td>string</td>
<td>类型1-收入2-成本3-税金及附加4-所得税5-净利润6-费用0-忽略</td>
</tr>
<tr>
<td>year_amount</td>
<td>string</td>
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				<span class="hljs-attr">&quot;current_amount&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;100&quot;</span><span class="hljs-punctuation">,</span>
				...
				<span class="hljs-attr">&quot;last_year_amount&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;100&quot;</span><span class="hljs-punctuation">,</span>
				...
				<span class="hljs-attr">&quot;year_amount&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;100&quot;</span>
			<span class="hljs-punctuation">}</span>
		<span class="hljs-punctuation">]</span>
