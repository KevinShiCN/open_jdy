---
title: "出纳资金收支趋势 更新于2024-01-19 09:03 复制链接"
product: "金蝶云星辰"
category: "财税云 > 出纳 > 出纳资金收支趋势"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=dca478a8b60211ee8bbab98c510c46de"
last_update: "2024-01-19 09:03"
crawl_date: "2026-03-03"
---

# 出纳资金收支趋势 更新于2024-01-19 09:03 复制链接

> 产品：金蝶云星辰 | 分类：财税云 > 出纳 > 出纳资金收支趋势

出纳资金收支趋势 更新于2024-01-19 09:03 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：出纳资金收支趋势接口
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/fi/ca_debit_and_credit_trend
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| 参数名称        | 参数类型   | 是否必填 | 参数说明                             |
| --- | --- | --- | --- |
| income_type | string | true | 收支类型， "1"-收入趋势，"2"-支出趋势          
| trend_type  | string | true | 趋势类型，"1"-最近一周，"2"-最近30天，"3"-最近一年 
...
<ul>
<li>用途说明：出纳资金收支趋势接口</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/fi/ca_debit_and_credit_trend</li>
</ul>
...
<td>string</td>
<td>true</td>
<td>收支类型， “1”-收入趋势，“2”-支出趋势</td>
</tr>
<tr>
<td>trend_type</td>
<td>string</td>
<td>true</td>
<td>趋势类型，“1”-最近一周，“2”-最近30天，“3”-最近一年</td>
</tr>
</tbody>
</table>
<h4><a id="_24"></a>请求示例</h4>
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/fi/ca_debit_and_credit_trend?income_type=1&amp;trend_type=1&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				...
				<span class="hljs-attr">&quot;date&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;2022-01-01&quot;</span>
			<span class="hljs-punctuation">}</span>
		<span class="hljs-punctuation">]</span>
