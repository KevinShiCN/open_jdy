---
title: "辅助核算类别列表 更新于2024-06-07 09:04 复制链接"
product: "金蝶云星辰"
category: "财税云 > 账簿 > 辅助核算类别列表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=e2181f42240611ef8e9d3b8ff9670bf1"
last_update: "2024-06-07 09:04"
crawl_date: "2026-03-03"
---

# 辅助核算类别列表 更新于2024-06-07 09:04 复制链接

> 产品：金蝶云星辰 | 分类：财税云 > 账簿 > 辅助核算类别列表

辅助核算类别列表 更新于2024-06-07 09:04 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：辅助核算类别列表（星辰3.1以上版本支持）
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/fi/assist_type_list
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| 参数名称              | 参数类型   | 参数说明                                            |
| --- | --- | --- |
| assistanttype_id  | string | 辅助资料类别id(value_source_id= "bd_auxinfo",才会有类别id) 
| flex_fie_id       | string | 辅助核算类别id，例如：f0001、f0002                         
| name              | string | 辅助核算类别，例如：客户、辅助资料下的具体类别                         
| value_source_id   | string | 辅助核算类别值来源id                                     
| value_source_name | string | 辅助核算类别值来源名称                                     
...
<ul>
<li>用途说明：辅助核算类别列表（星辰3.1以上版本支持）</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/fi/assist_type_list</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/fi/assist_type_list?page=1&amp;page_size=10&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
...
<tbody>
<tr>
<td>assistanttype_id</td>
<td>string</td>
<td>辅助资料类别id(value_source_id= “bd_auxinfo”,才会有类别id)</td>
</tr>
<tr>
<td>flex_fie_id</td>
<td>string</td>
<td>辅助核算类别id，例如：f0001、f0002</td>
</tr>
<tr>
<td>name</td>
<td>string</td>
<td>辅助核算类别，例如：客户、辅助资料下的具体类别</td>
</tr>
<tr>
<td>value_source_id</td>
<td>string</td>
<td>辅助核算类别值来源id</td>
</tr>
<tr>
<td>value_source_name</td>
<td>string</td>
<td>辅助核算类别值来源名称</td>
</tr>
</tbody>
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		...
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				<span class="hljs-attr">&quot;assistanttype_id&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;0001&quot;</span><span class="hljs-punctuation">,</span>
				<span class="hljs-attr">&quot;flex_fie_id&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;f0002&quot;</span><span class="hljs-punctuation">,</span>
				<span class="hljs-attr">&quot;name&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;客户&quot;</span><span class="hljs-punctuation">,</span>
				<span class="hljs-attr">&quot;value_source_id&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;bd_customer&quot;</span><span class="hljs-punctuation">,</span>
				<span class="hljs-attr">&quot;value_source_name&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;客户&quot;</span>
			<span class="hljs-punctuation">}</span>
