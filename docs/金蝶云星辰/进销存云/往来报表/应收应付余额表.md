---
title: "应收应付余额表 更新于2023-04-19 13:35 复制链接"
product: "金蝶云星辰"
category: "进销存云 > 往来报表 > 应收应付余额表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9c000922712511eda0b383ee5287960b"
last_update: "2023-04-19 13:35"
crawl_date: "2026-03-03"
---

# 应收应付余额表 更新于2023-04-19 13:35 复制链接

> 产品：金蝶云星辰 | 分类：进销存云 > 往来报表 > 应收应付余额表

应收应付余额表 更新于2023-04-19 13:35 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：获取应收应付余额表
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/arap/arap_balance
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| 参数名称   | 参数类型   | 是否必填  | 参数说明   |
| --- | --- | --- | --- |
| period | string | false | 查询年度期间 

#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/arap/arap_balance?period=201903' \
...
| 参数名称           | 参数类型   | 参数说明 |
| --- | --- | --- |
| ap_balance_for | string | 应付余额 
| ar_balance_for | string | 应收余额 
...
<ul>
<li>用途说明：获取应收应付余额表</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/arap/arap_balance</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/arap/arap_balance?period=201903&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
...
<tbody>
<tr>
<td>ap_balance_for</td>
<td>string</td>
<td>应付余额</td>
</tr>
<tr>
<td>ar_balance_for</td>
<td>string</td>
<td>应收余额</td>
</tr>
</tbody>
...
<pre><div class="hljs"><code class="lang-json"><span class="hljs-punctuation">{</span>
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		<span class="hljs-attr">&quot;ap_balance_for&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;100&quot;</span><span class="hljs-punctuation">,</span>
		<span class="hljs-attr">&quot;ar_balance_for&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;100&quot;</span>
