---
title: "应收账款汇总表 更新于2024-04-11 21:07 复制链接"
product: "金蝶云星辰"
category: "进销存云 > 往来报表 > 应收账款汇总表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9c00f383712511eda0b38f37a486e036"
last_update: "2024-04-11 21:07"
crawl_date: "2026-03-03"
---

# 应收账款汇总表 更新于2024-04-11 21:07 复制链接

> 产品：金蝶云星辰 | 分类：进销存云 > 往来报表 > 应收账款汇总表

应收账款汇总表 更新于2024-04-11 21:07 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：获取应收账款汇总表
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/arap/ar_summary_report
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| not_invoiced       | boolean | false | 是否显示已出库/退货未开票,默认为false，该字段仅旗舰版支持    
...
| 参数名称                | 参数类型   | 参数说明   |
| --- | --- | --- |
| balance_for         | string | 余额-应收  
| customer_group_id   | string | 客户分类id 
| customer_group_name | string | 客户分类名称 
...
<ul>
<li>用途说明：获取应收账款汇总表</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/arap/ar_summary_report</li>
</ul>
...
<td>boolean</td>
<td>false</td>
<td>是否显示已出库/退货未开票,默认为false，该字段仅旗舰版支持</td>
</tr>
<tr>
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		...
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				...
				<span class="hljs-attr">&quot;customer_group_id&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;1&quot;</span><span class="hljs-punctuation">,</span>
				<span class="hljs-attr">&quot;customer_group_name&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;小微企业&quot;</span><span class="hljs-punctuation">,</span>
