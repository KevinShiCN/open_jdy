---
title: "客户欠款余额 更新于2023-10-19 21:07 复制链接"
product: "金蝶云星辰"
category: "进销存云 > 往来报表 > 客户欠款余额"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9bfd710f712511eda0b3df014f3e47fe"
last_update: "2023-10-19 21:07"
crawl_date: "2026-03-03"
---

# 客户欠款余额 更新于2023-10-19 21:07 复制链接

> 产品：金蝶云星辰 | 分类：进销存云 > 往来报表 > 客户欠款余额

客户欠款余额 更新于2023-10-19 21:07 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：查询客户的上次欠款和应收款余额
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/arap/customer_debt
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| 参数名称        | 参数类型   | 是否必填  | 参数说明   |
| --- | --- | --- | --- |
| customer_id | array  | true  | 客户ID   
| currency_id | string | false | 单据币别ID 

#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/arap/customer_debt?customer_id=[]&currency_id=100' \
...
| 参数名称        | 参数类型   | 参数说明    |
| --- | --- | --- |
| all_debt    | number | 客户应收款余额 
| customer_id | string | 客户ID    
| last_debt   | number | 客户上次欠款  
...
<ul>
<li>用途说明：查询客户的上次欠款和应收款余额</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/arap/customer_debt</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/arap/customer_debt?customer_id=[]&amp;currency_id=100&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		<span class="hljs-attr">&quot;items&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				<span class="hljs-attr">&quot;all_debt&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-number">100</span><span class="hljs-punctuation">,</span>
				...
				<span class="hljs-attr">&quot;last_debt&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-number">100</span>
			<span class="hljs-punctuation">}</span>
		<span class="hljs-punctuation">]</span>
