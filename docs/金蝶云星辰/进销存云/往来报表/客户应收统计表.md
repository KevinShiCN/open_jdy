---
title: "客户应收统计表 更新于2023-10-19 21:07 复制链接"
product: "金蝶云星辰"
category: "进销存云 > 往来报表 > 客户应收统计表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9bb36fa6712511eda0b389e9e9908ca4"
last_update: "2023-10-19 21:07"
crawl_date: "2026-03-03"
---

# 客户应收统计表 更新于2023-10-19 21:07 复制链接

> 产品：金蝶云星辰 | 分类：进销存云 > 往来报表 > 客户应收统计表

客户应收统计表 更新于2023-10-19 21:07 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：获取客户应收统计表
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/arap/ar_report
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| customer_group_ids | array  | false | 客户类别id                              
| customer_ids       | array  | false | 客户id                                
...
| order_by           | string | false | 排序，1-金额降序  2-金额升序                   
| page               | string | false | 当前页，默认1                             
| page_size          | string | false | 每页显示条数默认10                          
| search             | string | false | 模糊搜索，支持供应商名称，联系人，联系方式               
| summary_type       | string | false | 汇总方式：客户item、业务员emp、部门dept、客户分类group 

#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/arap/ar_report?end_date=2022-01-01&start_date=2022-01-01&customer_group_ids=[]&customer_ids=[]&dept_ids=[]&emp_ids=[]&include_oth=true&include_uncheck=true&not_view_no_happen=true&not_view_zero=true&order_by=1 desc&page=1&page_size=100&search=001&summary_type=item' \
...
<ul>
<li>用途说明：获取客户应收统计表</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/arap/ar_report</li>
</ul>
...
<td>string</td>
<td>false</td>
<td>汇总方式：客户item、业务员emp、部门dept、客户分类group</td>
</tr>
</tbody>
</table>
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		...
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				...
				<span class="hljs-attr">&quot;scm_balance_for&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;100&quot;</span>
			<span class="hljs-punctuation">}</span>
