---
title: "客户交易次数 更新于1970-01-01 08:00 复制链接"
product: "金蝶云星辰"
category: "进销存云 > 往来报表 > 客户交易次数"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=7a02c661d70311eeaee3a9bb3e5e5382"
last_update: "1970-01-01 08:00"
crawl_date: "2026-03-03"
---

# 客户交易次数 更新于1970-01-01 08:00 复制链接

> 产品：金蝶云星辰 | 分类：进销存云 > 往来报表 > 客户交易次数

客户交易次数 更新于1970-01-01 08:00 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：客户交易次数接口
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/arap/customer_pay_number
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| 参数名称       | 参数类型   | 是否必填 | 参数说明               |
| --- | --- | --- | --- |
| end_date   | string | true | 结束时间，格式：2021-05-01 
| start_date | string | true | 开始时间，格式：2024-05-01 

#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/arap/customer_pay_number?end_date=2024-05-01&start_date=2024-01-01' \
...
```json
{
	"data":{
		"rows":[
			{
				"all_amount":100,
				"bill_date":"2023-06-02 00:00:00.0",
				"count":"1",
				"customer_id":"001",
				"customer_name":"订货散客"
			}
...
<li>用途说明：客户交易次数接口</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/arap/customer_pay_number</li>
</ul>
...
<td>string</td>
<td>true</td>
<td>结束时间，格式：2021-05-01</td>
</tr>
<tr>
<td>start_date</td>
<td>string</td>
<td>true</td>
<td>开始时间，格式：2024-05-01</td>
</tr>
</tbody>
</table>
<h4><a id="_24"></a>请求示例</h4>
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/arap/customer_pay_number?end_date=2024-05-01&amp;start_date=2024-01-01&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
	...
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				<span class="hljs-attr">&quot;all_amount&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-number">100</span><span class="hljs-punctuation">,</span>
				<span class="hljs-attr">&quot;bill_date&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;2023-06-02 00:00:00.0&quot;</span><span class="hljs-punctuation">,</span>
				...
				<span class="hljs-attr">&quot;customer_id&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;001&quot;</span><span class="hljs-punctuation">,</span>
				<span class="hljs-attr">&quot;customer_name&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;订货散客&quot;</span>
			<span class="hljs-punctuation">}</span>
		<span class="hljs-punctuation">]</span>
