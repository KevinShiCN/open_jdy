---
title: "预收退款单保存 更新于2025-07-11 16:37 复制链接"
product: "金蝶云星辰"
category: "进销存云 > 应收单据 > 预收退款单 > 预收退款单保存"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9bf0eded712511eda0b3279cb601518d"
last_update: "2025-07-11 16:37"
crawl_date: "2026-03-03"
---

# 预收退款单保存 更新于2025-07-11 16:37 复制链接

> 产品：金蝶云星辰 | 分类：进销存云 > 应收单据 > 预收退款单 > 预收退款单保存

预收退款单保存 更新于2025-07-11 16:37 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：预收退款单新增及修改。审核、删除等详见[通用操作接口](https://open.jdy.com/#/files/api/detail?index=2&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9e804b8c712511eda0b39f724d124b07)
- 请求方式：POST
...
| src_bill_type_id  | string | false | 源单类型(预收款单:ar_precreditbill) 
...
| id                  | string       | false | 分录id(新增时不传，修改时必传)                                                                                    
| pay_type_id         | string       | false | 退款方式id                                                                                               
| service_fee         | string       | false | 手续费                                                                                                  

#### 请求示例
```txt
curl --location --request  post 'https://api.kingdee.com/jdy/v2/arap/ar_pre_credit_ret' \
	...
	"source_bill_entry_list":[
		{
			...
			"id":"1",
			"src_bill_id":"1",
			"src_bill_type_id":"ar_precreditbill",
			"src_comment":"备注"
		}
	],
...
<ul>
<li>用途说明：预收退款单新增及修改。审核、删除等详见<a href="https://open.jdy.com/#/files/api/detail?index=2&amp;categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&amp;id=9e804b8c712511eda0b39f724d124b07" target="_blank">通用操作接口</a></li>
<li>请求方式：POST</li>
...
<td>string</td>
<td>false</td>
<td>源单类型(预收款单:ar_precreditbill)</td>
</tr>
<tr>
<td>src_comment</td>
<td>string</td>
...
<h4><a id="_62"></a>请求示例</h4>
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/arap/ar_pre_credit_ret&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
