---
title: "其他收入单保存 更新于2024-03-14 21:29 复制链接"
product: "金蝶云星辰"
category: "进销存云 > 应收单据 > 其他收入单 > 其他收入单保存"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9bd1f431712511eda0b3db668eb69867"
last_update: "2024-03-14 21:29"
crawl_date: "2026-03-03"
---

# 其他收入单保存 更新于2024-03-14 21:29 复制链接

> 产品：金蝶云星辰 | 分类：进销存云 > 应收单据 > 其他收入单 > 其他收入单保存

其他收入单保存 更新于2024-03-14 21:29 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：其他收入单新增及修改。审核、删除等详见[通用操作接口](https://open.jdy.com/#/files/api/detail?index=2&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9e804b8c712511eda0b39f724d124b07)
- 请求方式：POST
...
| pay_entry_list         | List <PayEntry>        | true  | 应收信息分录                                                                                               
...
| instant_pay_entry_list | List <InstantPayEntry> | false | 立即收款分录                                                                                               
...
| 参数名称                      | 参数类型         | 是否必填  | 参数说明                                                                                                 |
| --- | --- | --- | --- |
| instant_amount            | string       | true  | 收款金额                                                                                                 
| instant_settle_account_id | string       | true  | 收款账户id                                                                                               
...
#### 请求示例
```txt
curl --location --request  post 'https://api.kingdee.com/jdy/v2/arap/ar_other_credit' \
...
<ul>
<li>用途说明：其他收入单新增及修改。审核、删除等详见<a href="https://open.jdy.com/#/files/api/detail?index=2&amp;categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&amp;id=9e804b8c712511eda0b39f724d124b07" target="_blank">通用操作接口</a></li>
<li>请求方式：POST</li>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/arap/ar_other_credit&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
