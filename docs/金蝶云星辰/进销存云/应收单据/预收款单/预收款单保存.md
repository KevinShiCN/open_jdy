---
title: "预收款单保存 更新于2025-07-11 16:38 复制链接"
product: "金蝶云星辰"
category: "进销存云 > 应收单据 > 预收款单 > 预收款单保存"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9be3f598712511eda0b3c747afa9568d"
last_update: "2025-07-11 16:38"
crawl_date: "2026-03-03"
---

# 预收款单保存 更新于2025-07-11 16:38 复制链接

> 产品：金蝶云星辰 | 分类：进销存云 > 应收单据 > 预收款单 > 预收款单保存

预收款单保存 更新于2025-07-11 16:38 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：预收款单新增及修改。审核、删除等详见[通用操作接口](https://open.jdy.com/#/files/api/detail?index=2&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9e804b8c712511eda0b39f724d124b07)
- 请求方式：POST
...
| sel_bill_info_entry   | List <selBillInfoEntry> | false | 源单分录                                                                                                 
| total_discount_amount | string                  | false | 优惠金额                                                                                                 

**selBillInfoEntry**
| 参数名称              | 参数类型   | 是否必填  | 参数说明                       |
| --- | --- | --- | --- |
| cur_settle_amount | string | true  | 本次预收金额                     
| src_bill_amount   | string | true  | 源单金额                       
| src_bill_type_id  | string | true  | 源单类型id-销售订单:sal_bill_order 
...
#### 请求示例
```txt
curl --location --request  post 'https://api.kingdee.com/jdy/v2/arap/ar_pre_credit' \
...
<ul>
<li>用途说明：预收款单新增及修改。审核、删除等详见<a href="https://open.jdy.com/#/files/api/detail?index=2&amp;categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&amp;id=9e804b8c712511eda0b39f724d124b07" target="_blank">通用操作接口</a></li>
<li>请求方式：POST</li>
...
<tr>
<td>sel_bill_info_entry</td>
<td>List &lt;selBillInfoEntry&gt;</td>
<td>false</td>
<td>源单分录</td>
</tr>
<tr>
...
<p><strong>selBillInfoEntry</strong></p>
<table>
<thead>
<tr>
<th>参数名称</th>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/arap/ar_pre_credit&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
