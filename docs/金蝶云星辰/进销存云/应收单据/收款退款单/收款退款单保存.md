---
title: "收款退款单保存 更新于2025-07-10 21:14 复制链接"
product: "金蝶云星辰"
category: "进销存云 > 应收单据 > 收款退款单 > 收款退款单保存"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9bcdd57e712511eda0b3f71ce36b16a9"
last_update: "2025-07-10 21:14"
crawl_date: "2026-03-03"
---

# 收款退款单保存 更新于2025-07-10 21:14 复制链接

> 产品：金蝶云星辰 | 分类：进销存云 > 应收单据 > 收款退款单 > 收款退款单保存

收款退款单保存 更新于2025-07-10 21:14 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：收款退款单新增及修改。审核、删除等详见[通用操作接口](https://open.jdy.com/#/files/api/detail?index=2&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9e804b8c712511eda0b39f724d124b07)
- 请求方式：POST
...
| cur_total_instant_amount | string                 | false | 本次退款总金额                                                                                              
...
| 参数名称              | 参数类型   | 是否必填  | 参数说明                                                      |
| --- | --- | --- | --- |
| cur_settle_amount | string | false | 本次核销金额(不传值时，按源单列表从上往下顺序分摊收款金额)                            
| id                | string | false | 分录id(新增时不传，修改时必传)                                         
| src_bill_id       | string | false | 源单id                                                      
| src_bill_type_id  | string | false | 源单类型sal_bill_outbound、sal_bill_inbound、ar_othercreditbill 
...
#### 请求示例
```txt
curl --location --request  post 'https://api.kingdee.com/jdy/v2/arap/ar_credit_ret' \
...
<ul>
<li>用途说明：收款退款单新增及修改。审核、删除等详见<a href="https://open.jdy.com/#/files/api/detail?index=2&amp;categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&amp;id=9e804b8c712511eda0b39f724d124b07" target="_blank">通用操作接口</a></li>
<li>请求方式：POST</li>
...
<tr>
<td>cur_total_instant_amount</td>
<td>string</td>
<td>false</td>
<td>本次退款总金额</td>
</tr>
...
<td>string</td>
<td>false</td>
<td>本次核销金额(不传值时，按源单列表从上往下顺序分摊收款金额)</td>
</tr>
<tr>
<td>id</td>
<td>string</td>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/arap/ar_credit_ret&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
