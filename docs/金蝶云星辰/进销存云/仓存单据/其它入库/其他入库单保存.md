---
title: "其他入库单保存 更新于2025-12-18 21:50 复制链接"
product: "金蝶云星辰"
category: "进销存云 > 仓存单据 > 其它入库 > 其他入库单保存"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9df2d850712511eda0b3e72559b80991"
last_update: "2025-12-18 21:50"
crawl_date: "2026-03-03"
---

# 其他入库单保存 更新于2025-12-18 21:50 复制链接

> 产品：金蝶云星辰 | 分类：进销存云 > 仓存单据 > 其它入库 > 其他入库单保存

其他入库单保存 更新于2025-12-18 21:50 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
...
| trans_type_id   | string                | true  | 业务类型id，其他入库：12，调拨差异处理（调拨差异处理下推其他入库单时传递）：14                                                           
...
| supplier_number | string                | false | 供应商编码，supplier_id和supplier_number二选一                                                                 
...
| src_bill_type_id    | string       | false | 源单类型：销售订单sal_bill_order，销售出库单sal_bill_outbound，调拨差异处理(调拨差异处理下推其他入库单时传递)inv_tfdiff_bill_order，调拨出库单(修改调拨差异处理生成的其他入库单时传递)inv_tfout_bill_outbound 
...
<ul>
<li>用途说明：其他入库单新增及修改。审核、删除等详见<a href="https://open.jdy.com/#/files/api/detail?index=2&amp;categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&amp;id=9e804b8c712511eda0b39f724d124b07" target="_blank">通用操作接口</a></li>
<li>请求方式：POST</li>
...
<td>string</td>
<td>true</td>
<td>业务类型id，其他入库：12，调拨差异处理（调拨差异处理下推其他入库单时传递）：14</td>
</tr>
<tr>
<td>bill_no</td>
<td>string</td>
...
<td>string</td>
<td>false</td>
<td>供应商编码，supplier_id和supplier_number二选一</td>
</tr>
</tbody>
</table>
...
<td>string</td>
<td>false</td>
<td>源单类型：销售订单sal_bill_order，销售出库单sal_bill_outbound，调拨差异处理(调拨差异处理下推其他入库单时传递)inv_tfdiff_bill_order，调拨出库单(修改调拨差异处理生成的其他入库单时传递)inv_tfout_bill_outbound</td>
</tr>
<tr>
<td>src_entry_id</td>
<td>string</td>
...
<h4><a id="_75"></a>请求示例</h4>
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/scm/inv_other_in&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
