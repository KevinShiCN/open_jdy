---
title: "产品退库单保存 更新于2026-02-11 12:44 复制链接"
product: "金蝶云星辰"
category: "进销存云 > 仓存单据 > 产品退库 > 产品退库单保存"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=25044ae2f80411ee8bbaade64d9db3c9"
last_update: "2026-02-11 12:44"
crawl_date: "2026-03-03"
---

# 产品退库单保存 更新于2026-02-11 12:44 复制链接

> 产品：金蝶云星辰 | 分类：进销存云 > 仓存单据 > 产品退库 > 产品退库单保存

产品退库单保存 更新于2026-02-11 12:44 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
...
| src_bill_type_id    | string       | false | 源单类型，产品入库单inv_product_bill                                                                           
...
#### 请求示例
```txt
curl --location --request  post 'https://api.kingdee.com/jdy/v2/scm/inv_product_ret' \
	...
	"material_entity":[
		{
			...
			"qty":1,
			"sp_id":"1",
			"src_bill_type_id":"inv_product_bill",
			"src_entry_id":"11",
			"src_inter_id":"1",
...
<td>string</td>
<td>false</td>
<td>源单类型，产品入库单inv_product_bill</td>
</tr>
<tr>
<td>src_entry_id</td>
<td>string</td>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/scm/inv_product_ret&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
