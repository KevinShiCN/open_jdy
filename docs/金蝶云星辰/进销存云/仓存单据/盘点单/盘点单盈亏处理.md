---
title: "盘点单盈亏处理 更新于2023-04-19 13:35 复制链接"
product: "金蝶云星辰"
category: "进销存云 > 仓存单据 > 盘点单 > 盘点单盈亏处理"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9dcd27cf712511eda0b39d5f79be7add"
last_update: "2023-04-19 13:35"
crawl_date: "2026-03-03"
---

# 盘点单盈亏处理 更新于2023-04-19 13:35 复制链接

> 产品：金蝶云星辰 | 分类：进销存云 > 仓存单据 > 盘点单 > 盘点单盈亏处理

盘点单盈亏处理 更新于2023-04-19 13:35 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：盘点单盈亏处理
- 请求方式：POST
- 请求地址：https://api.kingdee.com/jdy/v2/scm/inv_check_bill_gain_loss_deal
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| gain_loss_type | string  | 盈亏类型，盘盈：1，盘亏：2，既有盘盈也有盘亏：3，无盈亏：0 
| gain_no        | string  | 盘盈单编码                           
| loss_id        | string  | 盘亏单ID                           
| loss_no        | string  | 盘亏单编码                           
...
<li>用途说明：盘点单盈亏处理</li>
<li>请求方式：POST</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/scm/inv_check_bill_gain_loss_deal</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/scm/inv_check_bill_gain_loss_deal&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
...
<tr>
<td>gain_loss_type</td>
<td>string</td>
<td>盈亏类型，盘盈：1，盘亏：2，既有盘盈也有盘亏：3，无盈亏：0</td>
</tr>
<tr>
<td>gain_no</td>
<td>string</td>
...
<pre><div class="hljs"><code class="lang-json"><span class="hljs-punctuation">{</span>
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		<span class="hljs-attr">&quot;gain_id&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;1033851548410637312&quot;</span><span class="hljs-punctuation">,</span>
		<span class="hljs-attr">&quot;gain_loss_type&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;1&quot;</span><span class="hljs-punctuation">,</span>
		<span class="hljs-attr">&quot;gain_no&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;PYD-20201127-00001&quot;</span><span class="hljs-punctuation">,</span>
		<span class="hljs-attr">&quot;loss_id&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;0&quot;</span><span class="hljs-punctuation">,</span>
		<span class="hljs-attr">&quot;loss_no&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;0&quot;</span><span class="hljs-punctuation">,</span>
