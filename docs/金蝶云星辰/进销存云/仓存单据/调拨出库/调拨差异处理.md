---
title: "调拨差异处理 更新于2023-04-19 13:35 复制链接"
product: "金蝶云星辰"
category: "进销存云 > 仓存单据 > 调拨出库 > 调拨差异处理"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9dfa7977712511eda0b367baf67480d0"
last_update: "2023-04-19 13:35"
crawl_date: "2026-03-03"
---

# 调拨差异处理 更新于2023-04-19 13:35 复制链接

> 产品：金蝶云星辰 | 分类：进销存云 > 仓存单据 > 调拨出库 > 调拨差异处理

调拨差异处理 更新于2023-04-19 13:35 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：调拨差异处理
- 请求方式：POST
- 请求地址：https://api.kingdee.com/jdy/v2/scm/inv_tfin_draw
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
--data-row '
{
	"data":[
		{
			"entry_id":"785454575074202624",
			"id":"785454575074201600"
		}
	],
	"type":"1"
}'
...
<li>用途说明：调拨差异处理</li>
<li>请求方式：POST</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/scm/inv_tfin_draw</li>
</ul>
...
<td>string</td>
<td>true</td>
<td>处理类型（1：下推其他入库单，2：下推其他出库单</td>
</tr>
</tbody>
</table>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/scm/inv_tfin_draw&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
...
<pre><div class="hljs"><code class="lang-json"><span class="hljs-punctuation">{</span>
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		<span class="hljs-attr">&quot;ids&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;784663422611499008&quot;</span>
