---
title: "拆卸单保存 更新于2025-05-15 21:11 复制链接"
product: "金蝶云星辰"
category: "进销存云 > 仓存单据 > 拆卸单 > 拆卸单保存"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9de591db712511eda0b36dd747af9651"
last_update: "2025-05-15 21:11"
crawl_date: "2026-03-03"
---

# 拆卸单保存 更新于2025-05-15 21:11 复制链接

> 产品：金蝶云星辰 | 分类：进销存云 > 仓存单据 > 拆卸单 > 拆卸单保存

拆卸单保存 更新于2025-05-15 21:11 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
...
- 请求方式：POST
- 请求地址：https://api.kingdee.com/jdy/v2/scm/inv_disassemble
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| cost_fee        | string                | false | 拆卸费用                                                                                                 
| cost_fee_entity | CostFeeEntity         | false | 拆卸费用明细                                                                                               
...
| ignore_warn     | boolean               | false | 是否忽略告警信息(如：成本分摊比例为空)保存，true:忽略，默认false                                                               
...
<ul>
<li>用途说明：拆卸单新增及修改。审核、删除等详见<a href="https://open.jdy.com/#/files/api/detail?index=2&amp;categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&amp;id=9e804b8c712511eda0b39f724d124b07" target="_blank">通用操作接口</a></li>
<li>请求方式：POST</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/scm/inv_disassemble</li>
</ul>
...
<td>boolean</td>
<td>false</td>
<td>是否忽略告警信息(如：成本分摊比例为空)保存，true:忽略，默认false</td>
</tr>
<tr>
<td>operation_key</td>
<td>string</td>
...
<h4><a id="_110"></a>请求示例</h4>
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/scm/inv_disassemble&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
