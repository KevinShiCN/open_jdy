---
title: "销售订单锁库 更新于2026-07-02 08:24 复制链接"
product: "金蝶云星辰"
category: "进销存云 > 销售单据 > 销售订单 > 销售订单锁库"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9e706d03712511eda0b37dc44e0f958f"
last_update: "2026-07-02 08:24"
crawl_date: "2026-07-20"
---

# 销售订单锁库 更新于2026-07-02 08:24 复制链接

> 产品：金蝶云星辰 | 分类：进销存云 > 销售单据 > 销售订单 > 销售订单锁库

销售订单锁库 更新于2026-07-02 08:24 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：销售订单锁库（20240829接口下线）
- 请求方式：POST
- 请求地址：https://api.kingdee.com/jdy/v2/scm/sail_order_lock
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| is_auto         | boolean               | true  | 是否自动锁库，功能同页面的自动锁库（自动查找库存进行锁库） 
| material_entity | List <MaterialEntity> | false | 指定商品行锁库 *当isAuto为false时必填     

**MaterialEntity**
| 参数名称     | 参数类型    | 是否必填  | 参数说明         |
| --- | --- | --- | --- |
| id       | string  | true  | 销售订单的商品行id   
| lock_qty | integer | true  | 锁库数量         
| sp_id    | string  | true  | 仓位 （没有时传0）   
| stock_id | string  | true  | 仓库           
| batch_no | string  | false | 批次 （没有时传空字符） 

#### 请求示例
```txt
curl --location --request  post 'https://api.kingdee.com/jdy/v2/scm/sail_order_lock' \
...
--data-row '
{
	"bill_id":"1076774724224175104",
	"is_auto":false,
	"material_entity":[
		{
			"batch_no":"",
			"id":"1033326147292655619",
			"lock_qty":50,
			"sp_id":"0",
			"stock_id":"1031118668320247808"
		}
	]
}'
```
...
<ul>
<li>用途说明：销售订单锁库（20240829接口下线）</li>
<li>请求方式：POST</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/scm/sail_order_lock</li>
</ul>
...
<td>boolean</td>
<td>true</td>
<td>是否自动锁库，功能同页面的自动锁库（自动查找库存进行锁库）</td>
</tr>
<tr>
<td>material_entity</td>
<td>List &lt;MaterialEntity&gt;</td>
<td>false</td>
<td>指定商品行锁库 *当isAuto为false时必填</td>
</tr>
</tbody>
</table>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/scm/sail_order_lock&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
