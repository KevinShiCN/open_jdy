---
title: "销售汇总表列表 更新于2025-01-03 21:46 复制链接"
product: "金蝶云星辰"
category: "进销存云 > 销售单据 > 销售汇总表 > 销售汇总表列表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9f42d6ccc38c11efb6442787d01017a4"
last_update: "2025-01-03 21:46"
crawl_date: "2026-03-03"
---

# 销售汇总表列表 更新于2025-01-03 21:46 复制链接

> 产品：金蝶云星辰 | 分类：进销存云 > 销售单据 > 销售汇总表 > 销售汇总表列表

销售汇总表列表 更新于2025-01-03 21:46 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：销售汇总表列表
- 请求方式：GET
- 请求地址：https://api.kingdee.com/jdy/v2/sal/sal_summary_rpt_ims
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| 参数名称                 | 参数类型    | 是否必填  | 参数说明                                                                 |
| --- | --- | --- | --- |
| filter_summary_field | string  | true  | 汇总依据,customerid：按客户                                                  
| end_date             | string  | false | 结束日期（“yyyy-MM-dd”）不传默认查本月，需要与start_date一起传递，开始日期和结束日期需要限定在6个月内，超过会报错 
| filter_material_id   | array   | false | 商品id，格式：["id","id","xxx"]                                            
| page                 | integer | false | 当前页，默认1                                                              
| page_size            | integer | false | 每页条数,默认100                                                           
| show_package         | boolean | false | 是否查询整件散包，true-是，false-否,不传默认false                                    
| start_date           | string  | false | 开始日期（“yyyy-MM-dd”）不传默认查本月，需要与end_date一起传递                            

#### 请求示例
```txt
curl --location --request  get 'https://api.kingdee.com/jdy/v2/sal/sal_summary_rpt_ims?filter_summary_field=customerid&end_date=2022-01-01&filter_material_id=[1,2,3]&page=1&page_size=100&show_package=false&start_date=2022-01-01' \
...
| --- | --- | --- |
| count         | string     | 总条数        
| cur_page_size | integer    | 每页条数,默认100 
...
| 参数名称               | 参数类型   | 参数说明               |
| --- | --- | --- |
| act_non_tax_amount | string | 实际不含税金额,精度是小数点后10位 
| all_amount         | string | 价税合计,精度是小数点后10位    
| base_qty           | number | 销售数量               
| base_unit_id       | string | 基本单位id             
| base_unit_name     | string | 基本单位名称             
| customer_id        | string | 客户id               
| customer_name      | string | 客户名称               
| material_category  | string | 商品类别               
| material_id        | string | 商品id               
| material_name      | string | 商品名称               
| material_number    | string | 商品编码               
| package            | string | 整件散包               
| tax_amount         | string | 税额,精度是小数点后10位      
...
<li>用途说明：销售汇总表列表</li>
<li>请求方式：GET</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/sal/sal_summary_rpt_ims</li>
</ul>
...
<tbody>
<tr>
<td>filter_summary_field</td>
<td>string</td>
<td>true</td>
<td>汇总依据,customerid：按客户</td>
</tr>
<tr>
<td>end_date</td>
<td>string</td>
<td>false</td>
<td>结束日期（“yyyy-MM-dd”）不传默认查本月，需要与start_date一起传递，开始日期和结束日期需要限定在6个月内，超过会报错</td>
</tr>
<tr>
<td>filter_material_id</td>
<td>array</td>
<td>false</td>
<td>商品id，格式：[“id”,“id”,“xxx”]</td>
</tr>
<tr>
<td>page</td>
<td>integer</td>
...
<td>boolean</td>
<td>false</td>
<td>是否查询整件散包，true-是，false-否,不传默认false</td>
</tr>
<tr>
<td>start_date</td>
<td>string</td>
<td>false</td>
<td>开始日期（“yyyy-MM-dd”）不传默认查本月，需要与end_date一起传递</td>
</tr>
</tbody>
</table>
<h4><a id="_29"></a>请求示例</h4>
<pre><div class="hljs"><code class="lang-txt">curl --location --request  get &#x27;https://api.kingdee.com/jdy/v2/sal/sal_summary_rpt_ims?filter_summary_field=customerid&amp;end_date=2022-01-01&amp;filter_material_id=[1,2,3]&amp;page=1&amp;page_size=100&amp;show_package=false&amp;start_date=2022-01-01&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
...
<td>string</td>
<td>实际不含税金额,精度是小数点后10位</td>
</tr>
<tr>
<td>all_amount</td>
<td>string</td>
<td>价税合计,精度是小数点后10位</td>
</tr>
<tr>
<td>base_qty</td>
<td>number</td>
...
<pre><div class="hljs"><code class="lang-json"><span class="hljs-punctuation">{</span>
	<span class="hljs-attr">&quot;data&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">{</span>
		...
		<span class="hljs-attr">&quot;cur_page_size&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-number">100</span><span class="hljs-punctuation">,</span>
		...
		<span class="hljs-attr">&quot;rows&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-punctuation">[</span>
			<span class="hljs-punctuation">{</span>
				...
				<span class="hljs-attr">&quot;material_category&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;电子产品&quot;</span><span class="hljs-punctuation">,</span>
				...
				<span class="hljs-attr">&quot;package&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;10cm&quot;</span><span class="hljs-punctuation">,</span>
				<span class="hljs-attr">&quot;tax_amount&quot;</span><span class="hljs-punctuation">:</span><span class="hljs-string">&quot;1&quot;</span>
			<span class="hljs-punctuation">}</span>
