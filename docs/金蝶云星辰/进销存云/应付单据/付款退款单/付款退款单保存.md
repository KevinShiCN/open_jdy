---
title: "付款退款单保存 更新于2024-06-27 21:13 复制链接"
product: "金蝶云星辰"
category: "进销存云 > 应付单据 > 付款退款单 > 付款退款单保存"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9b9400bc712511eda0b357afac42bd6c"
last_update: "2024-06-27 21:13"
crawl_date: "2026-03-03"
---

# 付款退款单保存 更新于2024-06-27 21:13 复制链接

> 产品：金蝶云星辰 | 分类：进销存云 > 应付单据 > 付款退款单 > 付款退款单保存

付款退款单保存 更新于2024-06-27 21:13 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：付款退款单新增及修改。审核、删除等详见[通用操作接口](https://open.jdy.com/#/files/api/detail?index=2&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9e804b8c712511eda0b39f724d124b07)
- 请求方式：POST
...
| pay_entry_list         | List <PayEntry>        | true  | 退款信息分录                                                                                               
...
| source_bill_entry_list | List <SourceBillEntry> | false | 源单信息分录                                                                                               
...
| src_bill_id       | string | false | 源单id                                                                                                  
| src_bill_type_id  | string | false | 付款单：ap_paybill、采购退货单：pur_bill_outbound、委外加工费（退货）：subm_process_cost_return、其他支出退款单：ap_otherpayretbill  
...
#### 请求示例
```txt
curl --location --request  post 'https://api.kingdee.com/jdy/v2/arap/ap_pay_ret' \
	...
	"source_bill_entry_list":[
		{
			...
			"id":"1",
			"src_bill_id":"1",
			"src_bill_type_id":"pur_bill_outbound",
			"src_comment":"备注"
		}
	],
	"supplier_id":"1",
...
<ul>
<li>用途说明：付款退款单新增及修改。审核、删除等详见<a href="https://open.jdy.com/#/files/api/detail?index=2&amp;categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&amp;id=9e804b8c712511eda0b39f724d124b07" target="_blank">通用操作接口</a></li>
<li>请求方式：POST</li>
...
<td>string</td>
<td>false</td>
<td>付款单：ap_paybill、采购退货单：pur_bill_outbound、委外加工费（退货）：subm_process_cost_return、其他支出退款单：ap_otherpayretbill</td>
</tr>
<tr>
<td>src_comment</td>
<td>string</td>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/arap/ap_pay_ret&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
