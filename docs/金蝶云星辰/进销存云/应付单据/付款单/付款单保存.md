---
title: "付款单保存 更新于2025-09-18 21:25 复制链接"
product: "金蝶云星辰"
category: "进销存云 > 应付单据 > 付款单 > 付款单保存"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9b78d795712511eda0b3bdf5c15cb63a"
last_update: "2025-09-18 21:25"
crawl_date: "2026-03-03"
---

# 付款单保存 更新于2025-09-18 21:25 复制链接

> 产品：金蝶云星辰 | 分类：进销存云 > 应付单据 > 付款单 > 付款单保存

付款单保存 更新于2025-09-18 21:25 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
...
| pay_entry_list         | List <PayEntry>        | true  | 付款信息分录                                                                                               
...
| pay_from_to_type       | string                 | false | 核销方式,1 : 按单核销 2：按分录核销，不传默认按单核销                                                                       
| remark                 | string                 | false | 备注                                                                                                   
| supplier_account_id    | string                 | false | 结算供应商收款账号id,基础资料-供应商详情-银行信息id                                                                        
...
| src_bill_type_id       | string                     | true  | 源单类型:采购入库单pur_bill_inbound,采购退货单sal_bill_inbound,其他支出单ap_otherpaybill 
| source_bill_entry_data | List <SourceBillEntryData> | false | 源单分录,应收应付参数选择款项核销方式为按分录核销时必填，按单据核销时不需要填                               
| src_comment            | string                     | false | 备注                                                                    
| unsettle_amount        | string                     | false | 源单未核销金额(修改时必传)                                                        

**SourceBillEntryData**
| 参数名称                      | 参数类型   | 是否必填  | 参数说明            |
| --- | --- | --- | --- |
| entry_settle_amount       | string | true  | 分录本次核销金额        
| src_entry_id              | string | true  | 源单的分录id         
| src_entry_settle_amount   | string | true  | 源单分录已核销金额，修改时必传 
| src_entry_unsettle_amount | string | false | 源单分录未核销金额，修改时必传 
	...
	"source_bill_entry_list":[
		{
			...
			"source_bill_entry_data":[
				{
					"entry_settle_amount":"100",
					"src_entry_id":"1",
					"src_entry_settle_amount":"100",
					"src_entry_unsettle_amount":"1"
				}
			],
			"src_bill_id":"1",
...
<ul>
<li>用途说明：付款单新增及修改。审核、删除等详见<a href="https://open.jdy.com/#/files/api/detail?index=2&amp;categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&amp;id=9e804b8c712511eda0b39f724d124b07" target="_blank">通用操作接口</a></li>
<li>请求方式：POST</li>
...
<tr>
<td>pay_from_to_type</td>
<td>string</td>
<td>false</td>
<td>核销方式,1 : 按单核销 2：按分录核销，不传默认按单核销</td>
</tr>
<tr>
<td>remark</td>
<td>string</td>
...
<tr>
<td>supplier_account_id</td>
<td>string</td>
<td>false</td>
<td>结算供应商收款账号id,基础资料-供应商详情-银行信息id</td>
</tr>
<tr>
...
<td>string</td>
<td>true</td>
<td>源单类型:采购入库单pur_bill_inbound,采购退货单sal_bill_inbound,其他支出单ap_otherpaybill</td>
</tr>
<tr>
<td>source_bill_entry_data</td>
<td>List &lt;SourceBillEntryData&gt;</td>
<td>false</td>
<td>源单分录,应收应付参数选择款项核销方式为按分录核销时必填，按单据核销时不需要填</td>
</tr>
<tr>
<td>src_comment</td>
<td>string</td>
...
<p><strong>SourceBillEntryData</strong></p>
<table>
<thead>
<tr>
<th>参数名称</th>
...
<tr>
<td>src_entry_settle_amount</td>
<td>string</td>
<td>true</td>
<td>源单分录已核销金额，修改时必传</td>
</tr>
<tr>
<td>src_entry_unsettle_amount</td>
<td>string</td>
<td>false</td>
<td>源单分录未核销金额，修改时必传</td>
</tr>
</tbody>
</table>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/arap/ap_credit&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
