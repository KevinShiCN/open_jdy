---
title: "其他支出单保存 更新于2024-06-13 21:51 复制链接"
product: "金蝶云星辰"
category: "进销存云 > 应付单据 > 其他支出单 > 其他支出单保存"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9b872f79712511eda0b30726c8d43c3f"
last_update: "2024-06-13 21:51"
crawl_date: "2026-03-03"
---

# 其他支出单保存 更新于2024-06-13 21:51 复制链接

> 产品：金蝶云星辰 | 分类：进销存云 > 应付单据 > 其他支出单 > 其他支出单保存

其他支出单保存 更新于2024-06-13 21:51 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：其他支出单新增及修改。审核、删除等详见[通用操作接口](https://open.jdy.com/#/files/api/detail?index=2&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=9e804b8c712511eda0b39f724d124b07)
- 请求方式：POST
...
| instantpayfromtoentry | List <InstantPayEntry> | true  | 立即付款分录                                                                                               
| pay_entry_list        | List <PayEntry>        | true  | 应付信息分录                                                                                               
...
| 参数名称                | 参数类型         | 是否必填  | 参数说明                                                                                                 |
| --- | --- | --- | --- |
| amount              | string       | true  | 应付金额（应大于0）                                                                                           
| pay_type_id         | string       | true  | 支出类别id                                                                                               
...
| no_tax_amount       | string       | false | 不含税金额(修改时需要带上)                                                                                       
| tax_rate            | string       | false | 税率                                                                                                   
| trans_number        | string       | false | 交易号/票据号                                                                                              

**InstantPayEntry**
| 参数名称                      | 参数类型         | 是否必填  | 参数说明                                                                                                 |
| --- | --- | --- | --- |
| instant_amount            | string       | true  | 付款金额                                                                                                 
| instant_settle_account_id | string       | true  | 付款账户id                                                                                               
| custom_entity_field       | Map <string> | false | 自定义字段[使用指南](https://open.jdy.com/#/files/api/detail?id=76567ff2a06311edaa4b3d71bf0fce53&noside=true) 
| id                        | string       | false | 分录id(新增时不传，修改时必传)                                                                                    
| instant_comment           | string       | false | 备注                                                                                                   
| instant_pay_type_id       | string       | false | 支出类别id                                                                                               
...
#### 请求示例
```txt
curl --location --request  post 'https://api.kingdee.com/jdy/v2/arap/ap_other_credit' \
...
<ul>
<li>用途说明：其他支出单新增及修改。审核、删除等详见<a href="https://open.jdy.com/#/files/api/detail?index=2&amp;categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&amp;id=9e804b8c712511eda0b39f724d124b07" target="_blank">通用操作接口</a></li>
<li>请求方式：POST</li>
...
<h4><a id="_67"></a>请求示例</h4>
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/arap/ap_other_credit&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
