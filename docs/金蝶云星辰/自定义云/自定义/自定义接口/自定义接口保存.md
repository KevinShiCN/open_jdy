---
title: "自定义接口保存 更新于1970-01-01 08:00 复制链接"
product: "金蝶云星辰"
category: "自定义云 > 自定义 > 自定义接口 > 自定义接口保存"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=0f675326ec9411f08fd1799dc53031e7"
last_update: "1970-01-01 08:00"
crawl_date: "2026-03-03"
---

# 自定义接口保存 更新于1970-01-01 08:00 复制链接

> 产品：金蝶云星辰 | 分类：自定义云 > 自定义 > 自定义接口 > 自定义接口保存

自定义接口保存 更新于1970-01-01 08:00 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
...
<li>用途说明：自定义接口保存</li>
<li>请求方式：POST</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/cust/save</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/cust/save&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
