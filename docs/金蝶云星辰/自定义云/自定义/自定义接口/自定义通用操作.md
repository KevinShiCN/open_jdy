---
title: "自定义通用操作 更新于1970-01-01 08:00 复制链接"
product: "金蝶云星辰"
category: "自定义云 > 自定义 > 自定义接口 > 自定义通用操作"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=0f688ba7ec9411f08fd11b9d4e0f7e7f"
last_update: "1970-01-01 08:00"
crawl_date: "2026-03-03"
---

# 自定义通用操作 更新于1970-01-01 08:00 复制链接

> 产品：金蝶云星辰 | 分类：自定义云 > 自定义 > 自定义接口 > 自定义通用操作

自定义通用操作 更新于1970-01-01 08:00 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：自定义通用操作
- 请求方式：POST
- 请求地址：https://api.kingdee.com/jdy/v2/cust/operate
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
| 参数名称          | 参数类型          | 是否必填 | 参数说明                             |
| --- | --- | --- | --- |
| entity_number | string        | true | 单据标识                             
| id            | List <string> | true | id                               
| operate_type  | string        | true | 操作类型，删除delete、审核audit、反审核unaudit 

#### 请求示例
```txt
curl --location --request  post 'https://api.kingdee.com/jdy/v2/cust/operate' \
...
--data-row '
{
	"entity_number":"ts_45465632434343",
	"id":[],
	"operate_type":"audit"
}'
```
...
<li>用途说明：自定义通用操作</li>
<li>请求方式：POST</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/cust/operate</li>
</ul>
...
<td>string</td>
<td>true</td>
<td>操作类型，删除delete、审核audit、反审核unaudit</td>
</tr>
</tbody>
</table>
<h4><a id="_25"></a>请求示例</h4>
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/cust/operate&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
