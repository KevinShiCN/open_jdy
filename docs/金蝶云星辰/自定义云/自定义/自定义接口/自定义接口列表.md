---
title: "自定义接口列表 更新于1970-01-01 08:00 复制链接"
product: "金蝶云星辰"
category: "自定义云 > 自定义 > 自定义接口 > 自定义接口列表"
source: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=3cc8ee9a663e11eda5c84b5d383a2b93&id=0f69eb39ec9411f08fd1f746aadb2f5d"
last_update: "1970-01-01 08:00"
crawl_date: "2026-03-03"
---

# 自定义接口列表 更新于1970-01-01 08:00 复制链接

> 产品：金蝶云星辰 | 分类：自定义云 > 自定义 > 自定义接口 > 自定义接口列表

自定义接口列表 更新于1970-01-01 08:00 复制链接    一级标题 二级标题 三级标题 四级标题 五级标题 六级标题                添加图片链接 上传图片
                                         
```
### 基本信息
- 用途说明：自定义接口列表
- 请求方式：POST
- 请求地址：https://api.kingdee.com/jdy/v2/cust/list
### 请求参数
#### headers参数
| 参数名称               | 参数示例                        | 是否必填 | 参数说明                                                                                                                                                             |
| --- | --- | --- | --- |
...
#### 请求示例
```txt
curl --location --request  post 'https://api.kingdee.com/jdy/v2/cust/list' \
...
<li>用途说明：自定义接口列表</li>
<li>请求方式：POST</li>
<li>请求地址：https://api.kingdee.com/jdy/v2/cust/list</li>
</ul>
...
<pre><div class="hljs"><code class="lang-txt">curl --location --request  post &#x27;https://api.kingdee.com/jdy/v2/cust/list&#x27; \
--header &#x27;Content-Type: application/json&#x27; \
--header &#x27;X-Api-ClientID: 205022&#x27; \
--header &#x27;X-Api-Auth-Version: 2.0&#x27; \
--header &#x27;X-Api-TimeStamp: 1655775240000&#x27; \
